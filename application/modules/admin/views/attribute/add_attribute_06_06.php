                                        ...
                                        <label class="switch">
                                          <input type="checkbox" <?php
                                            if ($listing['status'] == '1'): echo "checked";
                                             endif;?> onchange="checkStatus_user(this,'<?= $listing['attribute_id']; ?>');">
                                          <span class="slider round"></span>
                                        </label>
                                    </div>
                                    </td> 
                                    <td><a class="composemail" href="<?php echo site_url('admin/add-attribute/'.$listing['attribute_id']);?>">Edit</a></td> 
                                    </tr>
                                    <?php } endif; ?>  
                                </tbody>
                            </table>
