                                ...
                                <div class="card-body">
                                    <div class="eventrow">
                                        <div class="item-detail-buttons">
                                            <button type="button" class="btn btn-secondary active">Assign of Upfront</button>
                                    ...
                                    <div class="eventrow">
                                        <div class="assign-driver-buttons">
                                            <a href="javascript:void(0)"  class="btn btn-secondary">Assigned a driver</a>
                                        </div>
                                    </div>
                                    <div class="driver-asssign-status">
                                        <div class="status-part">
                                            <ul>
                                                <li>Start Job</li>
                                                <li>On the way</li>
                                                <li>Reached at location</li>
                                                <li>Collect amount</li>
                                                <li>Reached at hub</li>
                                                <li>Deposit amount</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="verify-admin">
                                        <a href="#">Verified by Admin</a>
                                    </div>
                                </div>
