...
<div class="content-wrapper">
    <div class="content-header sty-one">
        <h1>Service Sub-Category Management</h1>
        <ol class="breadcrumb">
            <li><a href="<?=base_url('admin');?>">Home</a></li>
            <li><i class="fa fa-angle-right"></i>Service Sub-Category Management</li>
        </ol>
    </div>
    ...
    <div class="content">
        <div class="row">
            <?php if(!isset($edit)) { ?>
                            ...
                            <div class="card-body"> 
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <a href="<?=base_url('admin/service-subcategory-list');?>" class="composemail mt-4 pull-right" style="margin-right: 3px;">Cancel</a>  
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <form method="post" action="<?=base_url('admin/bulk-service-subcategory-list');?>" enctype="multipart/form-data">
                            <div class="col-md-12 mb-4">
                                <label>Select Category</label>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php foreach($sub_category_list as $listing) { ?>
                                            ...
                                            <td>
                                                <a class="composemail fa_btn" href="<?php echo site_url('admin/service-subcategory-list/'.$listing['sub_category_id']);?>"><i class="fa fa-edit"></i></a>
