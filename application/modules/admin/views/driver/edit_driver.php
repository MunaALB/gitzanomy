                    ...
                    <div class="eventrow">
                        <div class="row m-t-2">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control regInputs" value="<?= set_value('name') ? set_value('name') : $driver_detail['name'] ?>" data-title="Full Name" id="name" name="name" type="text" placeholder="">
                        ...
                        <div class="row m-t-2" >
                            <div class="col-md-12" >
                                ...
                                <input type="hidden" name="location" data-title="Address"  class="form-control regInputs" id="location" value="<?= set_value('address') ? set_value('address') : $driver_detail['address'] ?>">
                                <input type="hidden" name="lat" id="lat" value="<?= set_value('latitude') ? set_value('latitude') : $driver_detail['latitude'] ?>" >
                                <input type="hidden" name="lng" id="lng" value="<?= set_value('longitude') ? set_value('longitude') : $driver_detail['longitude'] ?>">
                                <div id="pac-card">
                                    <div class="form-group" >
                                        ...
                                        <div class="row" style="padding-right: 10px;margin-top: 10px;">
                                            ...
                                            <div class='col-md-8' style="padding-left:0;">
                                                <input class="form-control regInputs" id="pac-input" data-title="Address" name="address" type="text" placeholder="Enter Location" value="<?= set_value('address') ? set_value('address') : $driver_detail['address'] ?>">
                                            </div></div>

                                        <input type="hidden" name="latitude" id="latitude" value="<?= set_value('latitude') ? set_value('latitude') : $driver_detail['latitude'] ?>">
                                        <input type="hidden" name="longitude" id="longitude" value="<?= set_value('longitude') ? set_value('longitude') : $driver_detail['longitude'] ?>">
                                    </div>
                                </div>
                                <div id="map"></div>
                            </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-12 col-xs-12">
                                <button style="cursor:pointer;" type="button" onclick="addDriver(this);" class="composemail save-length pull-right"> Update Detail</button>
                            </div>
                        </div>
                    </div>
                </form>
...
//                            } else {
                ...
                reg_form_data.append("driver_id", <?=$driver_detail['driver_id']?>);
...
//                                reg_form_data.append("country_code", country_code);
                ...
                reg_form_data.append("method", 'editDriver');
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (returnObject['error_code'] == 100) {
                            ...
                            window.location.href="<?=base_url()?>admin/driver-detail/<?=$driver_detail['driver_id']?>";
                        } else {
                            alert(returnObject['message']);
                        }
                    },
...
//            }
    ...
    <script type="text/javascript">
        function initMap() {
            var centerCoordinates = new google.maps.LatLng(<?= $driver_detail['latitude'] ?>, <?= $driver_detail['longitude'] ?>);
