                                        ...
                                        <?php if(isset($order['inventory_items']) and $order['inventory_items']): foreach ($order['inventory_items'] as $key => $items): ?>
                                            <div class="card m-b-3 ">
                                                <?php if($items['is_in_hub']==0){
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <input type="checkbox" onchange="checkOrderDataInternational(this,'<?=$order['order_id'];?>','1');" class="item_class_international item_class_css" value="<?=$items['order_item_id'];?>" name="select_item_international">
                                                        </div>
                                                    </div>
                                                <?php } } ?>
                                                <div class="card-body">
                                    ...
                                    <?php if(isset($order['vendor_items']) and $order['vendor_items']): foreach ($order['vendor_items'] as $key => $items): ?>
                                        <div class="card m-b-3">
                                            <?php if($items['is_in_hub']==0){
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <input type="checkbox" onchange="checkOrderDataInternational(this,'<?=$order['order_id'];?>','2');" class="item_class_international item_class_css item_class_vendor_product" value="<?=$items['order_item_id'];?>" name="select_item_international">
                                                    </div>
                                                </div>
                                            <?php } } ?>
                                            <div class="card-body">
                                            ...
                                            <?php if(isset($items['vendor_driver_order']['driver_order_status']) and $items['vendor_driver_order']['driver_order_status']==3){ ?>
                                                    <div class="verify-admin">
    ...
    <script>
        ...
        function assignForVendorPorduct(obj,orderId) {
            ...
            if(driver_id==undefined || driver_id=='undefined'){
                ...
                if (orderId) {
                    $('.item_class_vendor_product:checked').each(function(index, value){
                        if ($(this).val()) {
                            if(newData){
        ...
        function checkOrderDataInternational(o,t,type){
