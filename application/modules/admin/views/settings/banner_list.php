...
<div class="content-wrapper">
                            ...
                            <div class="card-body"> 
                                ...
                                <div class="row">
                                    <div class="col-md-12" id="banner_images">
                                        <label>Upload Banner Image (<strong style="color: red;font-size: 11px;">*notes (width 1440px height 300px)</strong>)</label>
    ...
    function getBannerType(o){
        var value=$(o).val();
        if(value==1){
            var html='<label>Upload Banner Image</label> (<strong style="color: red;font-size: 11px;">*notes (width 900px height 224px)</strong>)';
            ...
            var html='<label>Upload Banner Image</label> (<strong style="color: red;font-size: 11px;">*notes (width 1440px height 300px)</strong>)';
    ...
    <script type="text/javascript">
        ...
        function validImageApp(obj, i) {
            ...
            if((file.size/1024)<320){
                ...
                showErrorMessage('input-file-now-custom-2Error', 'Max Image size should be 300 kb');
            }
