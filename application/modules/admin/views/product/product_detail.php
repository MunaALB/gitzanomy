...
<div class="col-lg-4 col-xs-4 b-r">
                                                    ...
                                                    <br>
                                                    <p class="text-muted"><span style="background: red;color: #fff;padding: 3px;border-radius: 6px;"><?php if($product_list['is_express']){ echo "Available"; }else{ echo "Not Available"; } ?></span></p>
                                                </div>
