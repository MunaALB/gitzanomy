                            ...
                            <?php if($attribute): $i=0; foreach($attribute as $attr): $i++; ?>
                                ...
                                <input type=hidden value="<?=$attr['attribute_id'];?>" name="attribute[]">
                                   <label><?=$attr['name'];?></label>
                                       <select class="chosen form-control regInputs" name="attribute_value[]" data-title="<?=$attr['name'];?>" id="<?=$attr['attribute_mapping_id'].'_'.$i;?>">
                            ...
                            <div class="row m-t-2">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="file" onchange="validImage(this,'image1');" class="dropify regInputs" data-title="Image-1" id="image1" name="image[]" />
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="file" onchange="validImage(this,'image2');" class="dropify" data-title="Image-2" id="image2" name="image[]" />
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="file" onchange="validImage(this,'image3');" class="dropify" data-title="Image-3" id="image3" name="image[]" />
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="file" onchange="validImage(this,'image4');" class="dropify" data-title="Image-4" id="image4" name="image[]"/>
