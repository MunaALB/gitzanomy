...
<form method="POST" id="uploadProduct" enctype="multipart/form-data">
            ...
            <div class="content eventdeatil">  
                <div class="card">
                   <div class="card-header">
                       <h5 class="card-title">Product Images <span class="add-image-gallery"><a href="#galleryimageupload" data-toggle="modal" class="text white  mybtns">Add Image from Gallery</a></span></h5>
                    </div>
                    <div class="card-body">
                        <div class="eventrow">
                            <div class="row m-t-2">
