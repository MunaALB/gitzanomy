                ...
                $htmlData.='<li>';
                    $htmlData.='<div>';
                        $htmlData.='<table class="table table-bordered">';
                            ...
                            $htmlData.=' </tbody>';
                        $htmlData.='</table>';
                        $htmlData.='<p class="text-right"> <a class="btn view-cart" href="'.base_url('my-cart').'"><i class="fa fa-shopping-cart"></i>View Cart</a>&nbsp;&nbsp;&nbsp; <a class="btn btn-mega checkout-cart" href="'.base_url('checkout').'"><i class="fa fa-share"></i>Checkout</a></p>';
                    $htmlData.='</div>';
                $htmlData.='</li>';
            $htmlData.='</ul>';
            else: 
