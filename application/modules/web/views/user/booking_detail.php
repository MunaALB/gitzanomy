...
<div class="main-container container">
    ...
    <li><a style="color:red;" href="<?=base_url('');?>"><i class="fa fa-home"></i></a></li>
        ...
        <li><a style="color:red;" href="<?=base_url('en/booking-history');?>">My Booking</a></li>
                                ...
                                <div class="product-item-container">
                                    <div class="left-block">
                                        <div class="product-image-container">
                                            <a href="<?php echo base_url('en/service-detail/'.$requestDetail['service_id']); ?>" target="_self" title="Chicken swinesha">
                                    ...
                                    <div class="right-block">
                                        <div class="caption">
                                            <h4><a href="<?php echo base_url('en/service-detail/'.$requestDetail['service_id']); ?>" title="Chicken swinesha" target="_self"><?=$requestDetail['service_name']?></a></h4>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                    <?php if($requestDetail['is_paid']==1){ echo "Paid"; }else{ ?>  <a onclick="clickToPay(this,'<?=$requestDetail['service_id'];?>','<?=$requestDetail['booking_id'];?>')" class="btn btn-success" style="border-radius: 8px;padding: 3px 18px;cursor:pointer;">Pay Now</a> <?php } ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-left">
