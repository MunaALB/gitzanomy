...
<div class="main-container container">
    ...
    <li><a style="color:red;" href="<?=base_url('');?>"><i class="fa fa-home"></i></a></li>
        ...
        <li><a style="color:red;" href="<?=base_url('en/address');?>">Address</a></li>
        <li>Checkout</li>
    </ul>
    ...
    <?php if(isset($user_cart) and $user_cart): ?>
        <div class="row">
                                ...
                                <div class="checkout-shipping-methods select-addess">
                                    <div class="panel-body ">
                                        ...
                                        <div class="addnewaddress">
                                            <a href="<?=base_url('en/address');?>">Add new address</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="checkout-shipping-methods">
                                    <div class="panel-body ">
                                        ...
                                        <div class="radio">
                                            <label><input type="radio" value="2" name="payment">Online Payment</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div  class="col-sm-4">
                ...
                <?php
                if(isset($couponList) && $couponList): ?>
        ...
        if(t){
            ...
            if(addressData){
                ...
                swal({
                    ...
                    window.location.href='<?=base_url('en/address');?>';
                });
            }
                    ...
                    success: function (data) {
                        ...
                        if (returnObject.error_code == 200) {
                            ...
                            if(payment_type=='2'){
                                ...
                                window.location.href="<?=base_url('en/success/');?>"+returnObject['data']['order_id'];
                            }
                        }else{
                            window.location.href="<?=base_url('en/fail');?>";
                        }
                        //location.reload();
                    },
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (returnObject.error_code == 200) {
                            ...
                            window.location.href="<?=base_url('en/failure');?>";
                        }
                        //location.reload();
                    },
                    error: function (error) {
          ...
          var reg_form_data = new FormData();
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (returnObject.error_code == 200) {
                            window.location.href="<?=base_url('en/success/');?>"+a['order_id'];
                        }else{
                            window.location.href="<?=base_url('en/failure');?>";
                        }
                        //location.reload();
