            ...
            <div id="content" class="col-sm-9 user-rightpart">
                ...
                <div class="order-tabs">
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#activeorder" aria-controls="activeorder" role="tab" data-toggle="tab">Active Booking</a></li>
                        <li role="presentation" class=""><a href="#completeorder" aria-controls="completeorder" role="tab" data-toggle="tab">Complete Booking</a></li>
                    </ul>
                                    ...
                                    <?php if($active_booking): ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="price"> <span class="price-new">
                                                                <?php 
                                                                if($list['status']==1){ echo "Accepted"; } 
                                                                elseif($list['status']==2){ echo "On the way"; } 
                                                                else{ echo "In-Process"; } 
                                                                ?>
                                                            </span></div>
                                                        </td>
                                                        <td class="text-center">
                                                            <a class="btn btn-danger" title="" href="<?php echo base_url('en/booking-detail/'.$list['booking_id']); ?>" data-original-title="View"><i class="fa fa-eye"></i></a>
                                                        </td>
                                                    </tr>
                                        ...
                                        <?php else: ?>
                                            <div class="col-lg-12 col-md-12 messege-nodata" style="margin-top: -96px;">
                                                ...
                                                <h2 class="about-title" style="font-size: 11px;">No Active Booking Available.</h2>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="user-gridpoints">
                                    ...
                                    <?php if($complete_booking): ?>
                                        ...
                                        <?php else: ?>
                                            <div class="col-lg-12 col-md-12 messege-nodata" style="margin-top: -96px;">
                                                <i class="fa fa-shopping-bag" style="font-size: 50px;"></i>
                                                <h2 class="about-title" style="font-size: 11px;">No Completed Booking Available.</h2>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
