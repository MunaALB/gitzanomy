                            ...
                            <?php if(isset($wishlist) and $wishlist): foreach($wishlist as $fproduct): ?>
                                <tr>
                                    <td class="text-center">
                                        <a href="<?php echo base_url('en/product-detail/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $fproduct['name'])).'/'.$fproduct['product_id'].'/'.$fproduct['item_id']); ?>" target="_self" title="Chicken swinesha">
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo base_url('en/product-detail/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $fproduct['name'])).'/'.$fproduct['product_id'].'/'.$fproduct['item_id']); ?>" class="btn btn-primary" title=""><i class="fa fa-shopping-cart"></i>
                                        </a>
