...
.resp-save-address{
    display: inline;position: absolute;margin-left: 172px;margin-top: -42px;
}

@media (min-width: 354px) and (max-width: 767px) {

.resp-save-address{
    display: inline;position: absolute;margin-left: 128px;margin-top: -42px;
}
}
</style>
<div class="main-container container">
    <ul class="breadcrumb">
        ...
        <li><a style="color:red;" href="<?=base_url('en/my-cart');?>">My Cart</a></li>
        <li>Checkout</li>
    </ul>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group required">
                                                                    ...
                                                                    <select  class="form-control regInputs" disabled readonly id="country" name="country" data-title="Country">
                                                    ...
                                                    <div class="new-address">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group required">
                                                                    <label for="input-payment-address-1" class="control-label">Country</label>
                                                                    <select  class="form-control regInputs2" id="country2" readonly disabled name="country" data-title="Country">
                                                                        <!-- <option value="">--Select Country--</option>
                                                                        <?php if($country_code): foreach($country_code as $country): ?>
                                                                            <option value="<?=$country['country_code_id'];?>"><?=$country['name'];?></option>
                                                                        <?php endforeach; endif; ?> -->
                            ...
                            <?php else: ?>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><i class="fa fa-map-marker"></i> Guest User</h4>
                                    </div>
                                    <div class="checkout-shipping-methods select-addess">
                                        <div class="panel-body " id="guestMobileDivConfirm">
                                            ...
                                            <div class="well">
                                                <div class="new-address" >
                                                    <div class="buttons">
                                                        <div class="saveaddress"><a onclick="guestLoginDiv(this);" class="btn btn-primary">Guest Login</a></div>
                                                    </div>

                                                    <div class="buttons resp-save-address">
                                                        <div class="saveaddress"><a href="<?=base_url('en/user-login');?>" class="btn btn-primary">Login With Mobile</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="well">
                                                <div class="new-address" id="guestMobileDiv">
                                                    ...
                                                    <!-- <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group required">
                                                                <label for="input-payment-address-1" class="control-label">New Password</label>
                ...
                <div class="user-rightpart checkout-side">
                    <div class="buttons">
                        ...
                        <?php if(isset($user_cart['payble_amount']) and $user_cart['payble_amount']): ?>
                            <?php if($login_type==1):?>
                                <?php if($getAddress): ?>
                                    <div class="checkout-btn"><a href="<?=base_url('en/checkout');?>" id="placeOrderBtn" data-check="0" class="btn btn-primary">Checkout & Process</a></div>
                                <?php else: ?>
                            ...
                            <?php else: ?>
                                ...
                                <button onclick="placeOrder(this,2);" id="placeOrderBtn" data-check="0" class="button-disabled">Checkout &amp; Process</button></div>
                            <?php endif; ?>
                        <?php else: ?>
