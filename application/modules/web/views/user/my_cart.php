                                    ...
                                    <div class="product-item-container">
                                        <div class="left-block">
                                            <div class="product-image-container second_img">
                                                <a href="<?php echo base_url('en/product-detail/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $fproduct['name'])).'/'.$fproduct['product_id'].'/'.$fproduct['item_id']); ?>" target="_self" title="<?=$fproduct['name'];?>">
                                        ...
                                        <div class="right-block">
                                            <div class="caption">
                                                <h4><a href="<?php echo base_url('en/product-detail/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $fproduct['name'])).'/'.$fproduct['product_id'].'/'.$fproduct['item_id']); ?>" title="<?=$fproduct['name'];?>" target="_self"><?=$fproduct['name'];?>
                                                ...
                                                <div class="list-block">
                                                    <button class="compare btn-button" onclick="addToCart(this,'<?=$fproduct['product_id'];?>','<?=$fproduct['item_id'];?>','3');" type="button" title="Remove Item">Remove Item
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div  class="col-sm-5">
                    <div class="user-rightpart" id="my-cart-cart-total">
                        <h2 class="title">Cart Totals</h2>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-right"><?=count($user_cart['cart']);?> Items</td>
                                    </tr>
                                    <tr>
                                        <td class="text-left">
                            ...
                            <div class="buttons">
                                <div class="checkout-btn"><a href="<?php echo base_url('en/address'); ?>" class="btn btn-primary">Checkout</a></div>
                                <!-- <div class="checkout-btn"><a href="<?php echo base_url('en/checkout'); ?>" class="btn btn-primary">Checkout</a></div> -->
                            </div>
                    </div>
                </div>
            </div>
...
function loginRequired(o,t,i){
    if(t==1){
        showErrorMessage('genericError'+i,'*Need to login first.');
    }else if(t==2){
        showErrorMessage('genericError'+i,'Out Of Stock');
    }
}
