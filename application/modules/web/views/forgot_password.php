        ...
        <div id="content" class="col-sm-12">
            <div class="page-login forgotpassword">
                <div class="account-border">
                    <div class="row">
                        <form action="<?php echo base_url('en/verify-otp'); ?>" >
                            <div class="col-sm-6 customer-login col-sm-offset-3">
                                ...
                                <div class="bottom-form">
                                    <a href="<?php echo base_url('en/user-login'); ?>" class="forgot">Back to Login</a>
                                ...
                                success: function (data) {
                                    ...
                                    if (jsonData['error_code'] == 200) {
                                       alert(returnObject.message);
                                        window.location.href="<?=base_url('en/reset-password');?>";
                                    } else {
