    ...
    <div id="content">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><a href="<?=base_url('en/service-sub-category');?>"><?=$service['category_name'];?></a></li>
                <li><a href="<?=base_url('en/service-sub-category');?>"><?=$service['subcategory_name'];?></a></li>
                <li><?=$service['name'];?></li>
            </ul>
            <div class="row">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (returnObject.error_code == 200) {
                            ...
                            //location.reload();
                            window.location.href="<?=base_url('en/booking-success');?>";
                        }else{
                            alert(returnObject['message']);
                            window.location.href="<?=base_url('en/booking-failure');?>";
                        }
                        //location.reload();
                    },
                    error: function (error) {
