        ...
        <div class="container">
            <ul class="breadcrumb">
                ...
                <?php $uriName1=$this->uri->segment('4'); if(isset($uriName1) and ($uriName1)): ?>
                    <li><a style="color:red;" href="<?=base_url('en/service-category');?>"><?=$uriName1;?></a></li>
                <?php else: ?>
                ...
                <?php $uriName2=$this->uri->segment('5'); if(isset($uriName2) and ($uriName2)): ?>
                    <li><a style="color:red;" href="<?=base_url('en/service-subcategory/4/Cleaning');?>"><?=$uriName2;?></a></li>
                <?php else: ?>
                    <li><a style="color:red;" href="<?=base_url('en/service-subcategory/4/Cleaning');?>">Service Sub-Category</a></li>
                <?php endif; ?>
                                    ...
                                    <?php if(isset($vendor) and $vendor): foreach($vendor as $vendorRow): ?>
                                        <div class="col-md-2 col-xs-6">
                                            <div class="content-box">
                                                <div class="image-cat">
                                                    <a href="<?php echo base_url('en/service-list/'.$vendorRow['sub_category_id']).'/'.$vendorRow['vendor_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $vendorRow['category_name'])).'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $vendorRow['sub_category_name'])).'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $vendorRow['name'])); ?>" title="Vendor Name">
                                                ...
                                                <div class="cat-title">
                                                    ...
                                                    <a href="<?php echo base_url('en/service-list/'.$vendorRow['sub_category_id']).'/'.$vendorRow['vendor_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $vendorRow['category_name'])).'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $vendorRow['sub_category_name'])).'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $vendorRow['name'])); ?>" title="<?=$vendorRow['name'];?>"><?=$vendorRow['name'];?></a>
