                        ...
                        <div class="row">
                            <div class="col-sm-6 new-customer">
                                ...
                                <div class="bottom-form">
                                    <a href="<?php echo base_url('ar/user-registration'); ?>" class="btn btn-default pull-left">مواصلة التسجيل</a>
                                </div>
                            </div>
                            ...
                            <form action="<?php echo base_url(''); ?>" >
                                <div class="col-sm-6 customer-login">
                                    ...
                                    <div class="bottom-form">
                                        <a href="<?php echo base_url('ar/forgot-password'); ?>" class="forgot">كلمة سر المنسية</a>
                                        <input type="button" onclick="login(this);" value="تسجيل الدخول" class="btn btn-default pull-left" />
                                    </div>
                                </div>
                            </form>
                        </div>
