    ...
    <div id="content">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><a href="#">المنتجات حسب العلامات التجارية</a></li>
            </ul>
            <div class="row">
                            ...
                            <div class="product-layout col-md-3 col-sm-6 col-xs-12">
                                <div class="product-item-container">
                                    ...
                                    <div class="right-block">
                                        <div class="caption">
                                            <h4><a href="<?php echo base_url('ar/product-detail/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $fproduct['name_ar'])).'/'.$fproduct['product_id']); ?>" title="<?=$fproduct['name'];?>"><?=$fproduct['name'];?></a></h4>
