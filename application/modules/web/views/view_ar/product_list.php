    ...
    <div id="content">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><a style="color:red;" href="<?=base_url('ar/product-category');?>">فئات المنتجات</a></li>
                <?php
                ...
                <li><a style="color:red;" href="<?=base_url('ar/product-subcategory/'.$getViewQueryCat['category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $getViewQueryCat['name'])));?>">
                    <?php if(isset($getViewQueryCat['name_ar']) and $getViewQueryCat['name_ar']){ echo $getViewQueryCat['name_ar']; }else{ echo "فئات المنتجات"; } ?></a></li>
                
                <li>
                    <?php if(isset($getViewQuerySubCat['name_ar']) and $getViewQuerySubCat['name_ar']){ echo $getViewQuerySubCat['name_ar']; }else{ echo "فئة المنتج الفرعية"; } ?></li>
                ...
                <aside class="col-sm-3 col-md-3 content-aside productsfilter" id="column-left">
                    <?php if(isset($filterData['categoryList']) and $filterData['categoryList']):?>
                        <div class="module category-style">
                            ...
                            <div class="modcontent filterleft">
                                <div class="box-category">
                                    <ul id="cat_accordion" class="list-group">
                                        <?php if(isset($filterData['categoryList']) and $filterData['categoryList']): foreach($filterData['categoryList'] as $catFilter): ?>
                                            <li class="hadchild"><a href="<?=base_url('ar/product-subcategory/'.$catFilter['category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $catFilter['name'])));?>" class="cutom-parent"><?=$catFilter['name'];?></a> <span class="button-view  fa fa-plus-square-o"></span>
                                                <ul style="display: block;">
                                                    <?php if(isset($catFilter['sub_category']) and $catFilter['sub_category']): foreach($catFilter['sub_category'] as $subCat): ?>
                                                        <li><a <?php if($subCat['sub_category_id']==$uri2){ echo 'style="color: #ef5039;"'; }?> href="<?php echo base_url('ar/product-list/'.$subCat['category_id'].'/'.$subCat['sub_category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $subCat['name']))); ?>"><?=$subCat['name'];?></a></li>
                    ...
                    <?php if(isset($filterData['brand']) and $filterData['brand']):?>
                        <div class="module category-style">
                            <h3 class="modtitle">العلامة التجارية</h3>
                            <div class="modcontent filterleft">
                                <div class="table_layout filter-shopby">
                                    <div class="table_row">
                                        <ul class="checkboxes_list">
                        ...
                        <div class="modcontent filterleft">
                            <footer class="bottom_box">
                                        <div class="buttons_row">
                                            <!-- <button type="button" onclick="filterProduct(this);" class="button_grey button_submit">بحث</button> -->
                                            <button type="button" onclick="loadMoreProducts(this,'1');" class="button_grey button_submit">بحث</button>
                                            <button type="reset" onclick="resetFilter(this);" class="button_grey filter_reset">إعادة تعيين</button>
                                        </div>
                    ...
                    <div class="products-category">
                                ...
                                <div class="product-item-container">
                                    <div class="left-block">
                                        <div class="product-image-container <?php if(isset($fproduct['images'][1])): echo "second_img"; endif; ?>">
                                            <a href="<?php echo base_url('ar/product-detail/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $fproduct['name_ar'])).'/'.$fproduct['product_id']); ?>" title="<?=$fproduct['name'];?>">
                        ...
                        <div class="row"> 
                            <div class="col-lg-12 col-md-12 mt-2 text-center">
                                <a style="cursor:default;display:none;color:#fd5000;font-size: 20px;" id="loading_msg" >..جاري تحميل المزيد من المنتجات..</a>
                                <a id="loadmoreButton" hidden   style="cursor:default;text-decoration: underline;" data-page="1" onclick="loadMoreProducts(this,'2')">تحميل المزيد</a>
                            </div>
                        </div>
                        <?php endif; ?>
...
function filterProduct(o){
        ...
        //alert(url)
        if(url){
            window.location.href="<?=base_url('ar/product-list/'.$uri1.'/'.$uri2.'/'.$uri3.'?');?>"+url
        }else{
            window.location.href="<?=base_url('ar/product-list/'.$uri1.'/'.$uri2.'/'.$uri3);?>"
        }
