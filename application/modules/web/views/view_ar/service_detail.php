    ...
    <div id="content">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><a href="<?=base_url('ar/service-sub-category');?>"><?=$service['category_name'];?></a></li>
                <li><a href="<?=base_url('ar/service-sub-category');?>"><?=$service['subcategory_name'];?></a></li>
                <li><?=$service['name'];?></li>
            </ul>
            <div class="row">
                                    ...
                                    <div class="collapse" id="collapseExample">
                                        <div class="bookform">
                                            <div class="row">
                                                <div class="col-md-6">
                                                  <div class="form-group date">
                                                    <label for="exampleInputEmail1" style="font-size: 15px;">حدد تاريخ</label>
                                                ...
                                                <div class="col-md-6">
                                                  <div class="form-group">
                                                    <label for="exampleInputEmail1" style="font-size: 15px;">اختر الوقت</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                  <div class="form-group">
                                                    <label for="exampleInputEmail1" style="font-size: 15px;">إضافة ملاحظة (اختياري)</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                  <div class="form-group">
                                                    <button type="button" onclick="bookService(this);" class="btn btn-default">اطلب هذه الخدمة</button>
                                                  </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="collapse" id="collapseExample">
                                        <div class="bookform" id="guestMobileDiv">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="control-label" style="font-size: 15px;">رقم الهاتف</label>
                                        ...
                                        <div class="bookform" id="guestMobileDivOtp" style="display:none;">
                                            <div class="row">
                                                <div class="col-md-6">
                                                  ...
                                                  <p class="errorPrint" id="verificationGenericError"></p>
                                                    <label for="exampleInputEmail1" style="font-size: 15px;">أدخل الرمز المرسل الى الهاتف هنا</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                  <div class="form-group">
                                                    <button type="button" onclick="verifyOtp(this);" class="btn btn-default">تأكيد الرمز المرسل الى الهاتف</button>
                                                  </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="ltabs-wrap">
                        <div class="ltabs-tabs-container" data-rtl="yes" data-delay="300" data-duration="600" data-effect="starwars" data-ajaxurl="" data-type_source="0" data-lg="5" data-md="4" data-sm="2" data-xs="1" data-margin="30">              <div class="ltabs-tabs-wrap">   
                                <ul class="ltabs-tabs cf list-sub-cat font-title">                                  
                                    <li class="ltabs-tab tab-sel" data-category-id="61" data-active-content=".items-category-61"><span class="ltabs-tab-label">الخدمات الشبيهة</span></li>                                              
                                </ul>
                            </div>
                        </div>
                                                ...
                                                <div class="product-item-container">
                                                    <div class="left-block">
                                                        <div class="product-image-container second_img">
                                                            <a href="<?php echo base_url('ar/service-detail/'.$booking['service_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $booking['category_name'])).'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $booking['sub_category_name'])).'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $booking['name']))); ?>" title="Deep Cleansing Facial">
                                                    ...
                                                    <div class="right-block">
                                                        <div class="caption">
                                                            <h4><a href="<?php echo base_url('ar/service-detail/'.$booking['service_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $booking['category_name'])).'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $booking['sub_category_name'])).'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $booking['name']))); ?>" title="Deep Cleansing Facial"><?=$booking['name'];?></a></h4>
...
function submitReview(o,i,c){
    ...
    if(c==1){
        showErrorMessage('genericReviewError','تم تقديم المراجعة لهذا الحجز.');
    }else{
        if(reviewText && i){
            $.ajax({
...
function bookService(o,i,c){
    ...
    if(getDate){
        if(getDate>today){
            if(getTime){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (returnObject.error_code == 200) {
                            ...
                            //location.reload();
                            window.location.href="<?=base_url('ar/booking-success');?>";
                        }else{
                            alert(returnObject['message']);
                            window.location.href="<?=base_url('ar/booking-failure');?>";
                        }
                        //location.reload();
                    },
                    error: function (error) {
                ...
                showErrorMessage('timesError','*خانات إلْزاميّة');
            }
        }else{
            showErrorMessage('datesError','*يرجى تحديد التاريخ المستقبلي لحجز هذه الخدمة.');
        }
    }else{
        showErrorMessage('datesError','*خانات إلْزاميّة');
    }
}
    ...
    function guestLogin(o){
        ...
        if(mobile){
            ...
            showErrorMessage('mobileError','*خانات إلْزاميّة');
        }
    }
    ...
    function verifyOtp(obj){
        ...
        if (mobile && otp) {
                ...
                success: function (data) {
                    ...
                    if (returnObject.error_code == 200) {
                       ...
                       //window.location.href="<?=base_url();?>";
                        ...
                        swal({title:"تحذير.",text: returnObject.message,type: "warning"})
                    }
                },
                error: function (error) {
                     alert("error");
            ...
            if(mobile){
                ...
                swal({title:"تحذير.",text: "*رقم الجوال مطلوب.",type: "warning"})
            }
        }
    }
