    ...
    <li><a style="color:red;" href="<?=base_url('');?>"><i class="fa fa-home"></i></a></li>
        ...
        <li><a style="color:red;" href="<?=base_url('ar/order-history');?>">سجل أوامري</a></li>
        <li>تفاصيل الطلب</li>
    </ul>
                                    ...
                                    <div class="product-item-container">
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <a href="<?php echo base_url('ar/product-detail/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $items['product_name_ar'])).'/'.$items['product_id'].'/'.$items['item_id']); ?>" target="_self" title="Chicken swinesha">
                                        ...
                                        <div class="right-block">
                                            <div class="caption">
                                                <h4><a href="<?php echo base_url('ar/product-detail/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $items['product_name_ar'])).'/'.$items['product_id'].'/'.$items['item_id']); ?>" title="Chicken swinesha" target="_self"><?=$items['product_name'];?></a></h4>
                        ...
                        <table class="table table-bordered">
                          ...
                          <div class="buttons">
                            ...
                            <?php if($orderDetail['user_status']==3){ ?>
                                <div class="checkout-btn"><a href="<?=base_url('ar/user-bill/'.$orderDetail['order_id']);?>" class="btn btn-primary">فاتورتي</a></div>
                            <?php } ?>
                            </div>
                </div>
            </div>
