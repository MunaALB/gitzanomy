<div class="main-container container">
    <ul class="breadcrumb">
        ...
        <li><a style="color:red;" href="<?=base_url('ar/my-account');?>">User Dashboard</a></li>
                        ...
                        <tbody>
                            <?php if(isset($list) and $list): foreach($list as $fproduct): ?>
                                <tr>
                                    ...
                                    <td class="text-center"><a href="<?=base_url('ar/order-detail/'.$fproduct['order_id']);?>"><i class="fa fa-eye"></i></a></td>
