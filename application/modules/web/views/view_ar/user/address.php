                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="checkout-shipping-methods select-addess">
                                        <div class="panel-body " id="guestMobileDivConfirm">
                                            ...
                                            <div class="well">
                                                <div class="new-address" >
                                                    <div class="buttons resp-guest-button">
                                                    ...
                                                    <div class="buttons resp-save-address">
                                                        <div class="saveaddress"><a href="<?=base_url('ar/user-login');?>" class="btn btn-primary">تسجيل الدخول باستخدام هاتفك المحمول</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="user-rightpart checkout-side">
                    <div class="buttons">
                        ...
                        <?php if(isset($user_cart['payble_amount']) and $user_cart['payble_amount']): ?>
                            <?php if($login_type==1):?>
                                <?php if($getAddress): ?>
                                    <div class="checkout-btn"><a href="<?=base_url('ar/checkout');?>" id="placeOrderBtn" data-check="0" class="btn btn-primary">تأكيد عملية الشراء</a></div>
                                <?php else: ?>
