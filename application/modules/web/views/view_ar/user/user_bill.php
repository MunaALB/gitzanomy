            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <?php if(isset($orderDetail['order_item']) and $orderDetail['order_item']): 
                            ...
                            <tr>
                                <td class="text-left"><a href="<?php echo base_url('ar/product-detail/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $items['product_name'])).'/'.$items['product_id'].'/'.$items['item_id']); ?>" title="Chicken swinesha" target="_self"><?=$items['product_name'];?></a></td>
