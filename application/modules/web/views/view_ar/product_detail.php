    ...
    <div id="content">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><a style="color:red;" href="<?=base_url('ar/product-category');?>">فئة المنتج</a></li>
                <!-- <li><a style="color:red;" href="<?=base_url('ar/product-subcategory/'.$product['category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $product['category_name'])));?>">
                    <?php if(isset($product['category_name']) and $product['category_name']){ echo $product['category_name']; }else{ echo "فئة المنتج"; } ?></a></li> -->


                <li><a style="color:red;" href="<?=base_url('ar/product-subcategory/'.$product['category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $product['category_name'])));?>">
                    <?php if(isset($product['category_name']) and $product['category_name']){ echo $product['category_name']; }else{ echo "فئة المنتج"; } ?></a></li>
                <li><a style="color:red;" href="<?=base_url('ar/product-list/'.$product['category_id'].'/'.$product['sub_category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $product['subcategory_name'])));?>">
                            ...
                            <div class="content-product-right col-md-7 col-sm-12 col-xs-12">
                                ...
                                <div class="product-box-desc product-brandss">
                                    <div class="inner-box-desc">
                                        ...
                                        <div class="brand" style="color: #ef4d32 !important;"><span>توصيلة متوقعة : </span><?=($product['expected_delivery']) ? date('Y-m-d', strtotime('+'.$product['expected_delivery'].' days')):"N/A";?></div>
                                    </div>
                                </div>
                                                ...
                                                <div class="form-group box-info-product specification-detail">
                                                    ...
                                                    <div class="cart">
                                                        ...
                                                        foreach($product['product_attributes'] as $selectedKey=>$selectedVal):
                                                            ...
                                                            endforeach; endif;
                                                            ?>
                                                            <a href="<?php echo base_url('ar/product-detail/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $product['name'])).'/'.$product['product_id'].'/'.$val['item_id']); ?>" id="val_<?=$val['attribute_value_id'];?>" class="btn btn-mega btn-lg <?=$selectedClass;?> " <?=$selectedStyle;?> ><?=$val['value'];?></a>
                                                    </div>
                                                    <?php endforeach; endif; ?>
                                                </div>
                                            </div>
                                                ...
                                                <label>
                                                    ...
                                                    <div class="card-input">
                                                        ...
                                                        <div class="vendor-detail">
                                                            ...
                                                            <div class="">    
                                                                <a href="<?=base_url('ar/product-detail/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $product['name'])).'/'.$firstVendor['product_id']);?>"><?=$firstVendor['price'];?> LYD</a>
                                                            </div>
                                                            <!--<div class="rating">
