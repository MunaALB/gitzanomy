                                    ...
                                    <?php if(isset($category) and $category): foreach($category as $cat): ?>
                                        <div class="col-md-2 col-xs-6">
                                            <div class="content-box">
                                                <div class="image-cat">
                                                    <a href="<?php echo base_url('en/service-subcategory/'.$cat['category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $cat['name']))); ?>" title="<?=$cat['name'];?>">
                                                        <img src="<?=$cat['image'];?>" title="<?=$cat['name'];?>" alt="210 X 210" />
                                                    </a>
                                                </div>
                                                <div class="cat-title"> 
                                                <a href="<?php echo base_url('en/service-subcategory/'.$cat['category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $cat['name']))); ?>" title="Salon"><?=$cat['name'];?></a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
