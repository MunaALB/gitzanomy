...
if ($_POST['method'] == 'addToCart') {
    $model = new Api_model();
    $user = $this->session->userdata('zanomy_user_logged_in');
    $langSession = $this->session->userdata('zanomy_language_session');

    if(isset($user) and $user){
        $loginUserId=$user['user_id'];
    }else{
        // echo $_COOKIE["zanomycookie"];exit;
                ...
                $htmlData.='<div class="shopcart">';
                    $htmlData.='<span class="icon-c"><i class="fa fa-shopping-bag"></i></span>';
                        $htmlData.='<div class="shopcart-inner">';
                            $htmlData.='<p class="text-shopping-cart">سلتي</p>';
                                $htmlData.='<span class="total-shopping-cart cart-total-full">';
                                    $htmlData.='<span class="items_cart">';
                                        $htmlData.=count($user_cart['cart']);
                                            $htmlData.='</span><span class="items_cart2"> العناصر</span><span class="items_carts"> - ';
                        ...
                        $htmlData.='<li>';
                            $htmlData.='<div>';
                                $htmlData.='<table class="table table-bordered">';
                                    $htmlData.='<tbody>';
                                        $htmlData.='<tr>';
                                            $htmlData.='<td class="text-left"><strong>إجمالي العناصر</strong></td>';
                                            $htmlData.='<td class="text-right">'.count($user_cart['cart']).'</td>';
                                        $htmlData.='</tr>';
                                        $htmlData.='<tr>';
                                            $htmlData.='<td class="text-left"><strong>المجموع</strong></td>';
                                            $htmlData.='<td class="text-right">'.($user_cart['total_amount']).' LYD</td>';
                                        $htmlData.='</tr>';
                                    $htmlData.=' </tbody>';
                                $htmlData.='</table>';
                                $htmlData.='<p class="text-right"> <a class="btn view-cart" href="'.base_url($langSession.'/my-cart').'"><i class="fa fa-shopping-cart"></i>عرض السلة</a>&nbsp;&nbsp;&nbsp; <a class="btn btn-mega checkout-cart" href="'.base_url($langSession.'/address').'"><i class="fa fa-share"></i>الدفع</a></p>';
                            $htmlData.='</div>';
                        $htmlData.='</li>';
                    $htmlData.='</ul>';
                    else: 
                        ...
                        $htmlData.='<li>';
                            $htmlData.='<div>';
                                $htmlData.='<table class="table table-bordered">';
                                    ...
                                    $htmlData.=' </tbody>';
                                $htmlData.='</table>';
                                $htmlData.='<p class="text-right"> <a class="btn view-cart" href="'.base_url($langSession.'/my-cart').'"><i class="fa fa-shopping-cart"></i>View Cart</a>&nbsp;&nbsp;&nbsp; <a class="btn btn-mega checkout-cart" href="'.base_url($langSession.'/address').'"><i class="fa fa-share"></i>Checkout</a></p>';
                            $htmlData.='</div>';
                        $htmlData.='</li>';
                    $htmlData.='</ul>';
                    else: 
