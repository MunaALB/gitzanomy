            ...
            <div id="content">
                <div class="container">
                    <div class="so-categories module custom-slidercates">
                        <h3 class="modtitle"><span>Product Categories</span></h3>
                               ...
                               <?php if($category): foreach($category as $cat): ?>
                                <div class="col-md-2 col-xs-6">
                                    <div class="content-box">
                                        ...
                                        <div class="cat-title"> 
                                          <a href="<?php echo base_url('en/product-subcategory/'.$cat['category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $cat['name']))); ?>" title="Accessories "><?=$cat['name'];?></a>
                                        </div>
                                    </div>
                                </div>
                                <?php endforeach; ?>
