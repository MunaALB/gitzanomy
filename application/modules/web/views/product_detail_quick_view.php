    ...
    <div id="wrapper" class="wrapper-fluid banners-effect-10">
        <script>
            function searchProductData(o){
                ...
                if(valueData){
                    window.location.href="<?=base_url('en/search-product/');?>"+valueData;
                }
            }
                                                ...
                                                <div class="form-group box-info-product specification-detail">
                                                    ...
                                                    <div class="cart">
                                                        ...
                                                        foreach($product['product_attributes'] as $selectedKey=>$selectedVal):
                                                            ...
                                                            endforeach; endif;
                                                            ?>
                                                            <a href="<?php echo base_url('en/quick-view-product-detail/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $product['name'])).'/'.$product['product_id'].'/'.$val['item_id']); ?>" id="val_<?=$val['attribute_value_id'];?>" class="btn btn-mega btn-lg <?=$selectedClass;?> " <?=$selectedStyle;?> ><?=$val['value'];?></a>
                                                    </div>
                                                    <?php endforeach; endif; ?>
                                                </div>
                                            </div>
