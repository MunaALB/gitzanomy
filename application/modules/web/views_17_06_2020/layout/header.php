                ...
                <div class="container">
                    <div class="row">
                        <div class="header-top-left  col-lg-6 col-md-5 col-sm-6 col-xs-12">
                            <div class="hidden-sm welcome-msg"><span>Location for Service : </span> <b><i class="fa fa-map-marker"></i></b> H-5454 New Road Libya <span class="editaddress"><a href="#"><i class="fa fa-edit"></i></a></span></div>
                        </div>
