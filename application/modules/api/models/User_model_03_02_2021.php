...
class User_model extends CI_Model {
    ...
    function sendIosPush($deviceToken, $msg_data) {
        ...
        stream_context_set_option($ctx, 'ssl', 'local_cert', 'apns_cert/ck_production_live.pem'); // Pem file to generated // openssl pkcs12 -in pushcert.p12 -out pushcert.pem -nodes -clcerts // .p12 private key generated from Apple Developer Account
