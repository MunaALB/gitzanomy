...
<html lang="en">
    ...
    <head>
        ...
        <meta property="og:image" content="<?php echo site_url(); ?>assets/vendor/images/logo/og.png" />
        ...
        <link rel="stylesheet" href="<?php echo site_url(); ?>assets/vendor/css/chosen.min.css">
        ...
        <link rel="stylesheet" href="<?php echo site_url(); ?>assets/vendor/plugins/chartist-js/chartist.min.css">
        <link rel="stylesheet" href="<?php echo site_url(); ?>assets/vendor/plugins/chartist-js/chartist-plugin-tooltip.css"> 
                ...
                <nav class="navbar blue-bg navbar-static-top"> 
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu p-ph-res"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">  <span class="hidden-xs">Vendor</span> <img src="<?php echo site_url(); ?>assets/vendor/images/user.png" class="user-image" alt="User Image"></a>
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo site_url('vendor/my-profile'); ?>"><i class="fa fa-user"></i> My Profile</a></li> 
                                    <li><a href="<?php echo site_url('vendor/logout'); ?>"><i class="fa fa-sign-out"></i> Logout</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
