...
<form method="POST" id="uploadProduct" enctype="multipart/form-data">
    ...
    <div class="content eventdeatil">  
        <div class="card">
            ...
            <a href="<?=base_url('vendor/bulk-upload-product');?>" style="float: right;color: #fff;cursor: pointer;">Add From Excel</a>
                                    ...
                                    <?php if($list['error']): 
                                        ...
                                        <tr style="<?=$classData;?>">
                                            ...
                                            <td><?php if($list['expected_delivery_error']){
                                                        echo '<i class="fa fa-dot-circle-o" title="Required Field" aria-hidden="true" style="color: red;position: absolute;margin: -15px 56px"></i>';
                                                    } ?>
...
function showData(o,i,t){
    ...
    function uploadData(o){
        ...
        $.ajax({
                url: "<?php echo base_url("/vendor/Bulk/updating_data") ?>",
                type: "POST",
                data: form_data,
                ...
                success: function (data) {
                    ...
                    // alert(data+'==success')
                    if(data=='success'){
                        window.location.href="<?=base_url('vendor/edit-bulk-upload-product');?>";
                    }else{
