                                ...
                                <div class="eventrow">
                                    <div class="row m-t-2">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control chosen regInputs chosen-rtl" data-title="الفئة " id="category" name="category_id" onchange="getSubCategory(this);">
                                                <option value="">--اختر الفئة--</option>
                                                <?php if ($category_list): foreach ($category_list as $list): ?>
                                                        <option value="<?= $list['category_id']; ?>" <?= set_value('category_id') ? ( $list['category_id'] == set_value('category_id') ? 'selected' : '') : '' ?>><?= $list['name_ar']; ?></option>
                                                        <?php
                                                    endforeach;
                                                endif;
                                                ?>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control chosen regInputs chosen-rtl" data-title="تصنيف فرعي" id="sub_category" name="sub_category_id" onchange="getMappedBrand(this);">
                                ...
                                <div class="eventrow">
                                    <div class="row m-t-2">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control chosen regInputs chosen-rtl" id="brand" data-title="علامة تجارية" name="brand_id" onchange="getbrandModel(this);">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="model" class="form-control chosen regInputs chosen-rtl" name="model_id" data-title="ازالة التصفية">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (jsonData['error_code'] == 100) {
                            ...
                            $(jsonData).each(function (i, v) {
                                //alert(v['sub_category_id'])
                                html += '<option value="' + v['model_id'] + '" data-id="' + v['brand_id'] + '">' + v['name_ar'] + '</option>';
                            });
                            $("#model").append(html);
