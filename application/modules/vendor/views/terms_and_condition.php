...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/css/et-line-font/et-line-font.css" />
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/css/themify-icons/themify-icons.css" />
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/css/simple-lineicon/simple-line-icons.css" />
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/plugins/datatables/css/dataTables.bootstrap.min.css" />
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/css/skins/_all-skins.min.css" />
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/plugins/formwizard/jquery-steps.css" />
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/plugins/dropify/dropify.min.css" />
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/css/font/stylesheet.css" />
    </head>
    <style type="text/css">
        .policy-pages {
            padding-top: 50px;
    ...
    <body>
        <div class="container-fluid policy-pages">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2><strong>Terms and Conditions</strong></h2>
                        <p>Welcome to zanomy.com!</p>
                        <p>These terms and conditions outline the rules and regulations for the use of Zanomy's Website, located at www.zanomy.com.</p>
                        <p>
                            By accessing this website we assume you accept these terms and conditions. Do not continue to use zanomy.com if you do not agree to take all of the terms and conditions stated on this page. Our Terms and
                            Conditions were created with the help of the <a href="http://zanomy.ly/">Terms And Conditions Generator</a> and the <a href="http://zanomy.ly/">Free Terms &amp; Conditions Generator</a>.
                        </p>
                        <p>
                        ...
                        <p>We employ the use of cookies. By accessing zanomy.com, you agreed to use cookies in agreement with the Zanomy's Privacy Policy.</p>
                        <p>
                        ...
                        <p>
                            Unless otherwise stated, Zanomy and/or its licensors own the intellectual property rights for all material on zanomy.com. All intellectual property rights are reserved. You may access this from zanomy.com for
                            your own personal use subjected to restrictions set in these terms and conditions.
                        </p>
                        <p>You must not:</p>
                        <ul>
                            <li>Republish material from zanomy.com</li>
                            <li>Sell, rent or sub-license material from zanomy.com</li>
                            <li>Reproduce, duplicate or copy material from zanomy.com</li>
                            <li>Redistribute content from zanomy.com</li>
                        </ul>
                        <p>This Agreement shall begin on the date hereof.</p>
                        <p>
                            Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Zanomy does not filter, edit, publish or review Comments prior to their presence
                            on the website. Comments do not reflect the views and opinions of Zanomy,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent
                            permitted by applicable laws, Zanomy shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
                            Comments on this website.
                        </p>
                        <p>Zanomy reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
                        ...
                        <p>You hereby grant Zanomy a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
                        ...
                        <p>
                            ...
                            negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Zanomy; and (d) the link is in the context of general resource information.
                        </p>
                        <p>
                        ...
                        <p>
                            If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Zanomy. Please include your name, your organization name,
                        ...
                        <p>No use of Zanomy's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
        ...
        <script src="<?php echo base_url('assets/vendor/plugins/jquery-sparklines/jquery.sparkline.min.js'); ?>"></script>
        <script src="<?php echo base_url('assets/vendor/plugins/jquery-sparklines/sparkline-int.js'); ?>"></script>
        <script src="<?php echo base_url('assets/vendor/plugins/raphael/raphael-min.js'); ?>"></script>
        <script src="<?php echo base_url('assets/vendor/plugins/morris/morris.js'); ?>"></script>
        <script src="<?php echo base_url('assets/vendor/plugins/functions/dashboard1.js'); ?>"></script>
