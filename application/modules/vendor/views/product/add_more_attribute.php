                        ...
                        <div class="row m-t-2">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control regInputs numberOnly" data-title="Stock" id="stock" name="stock" type="text" placeholder="">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control regInputs numberOnly" data-title="Price" id="price" name="price" type="text" placeholder="">
                ...
                <div class="card-body">
                    <div class="eventrow">
                        <div class="row m-t-2">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input onchange="validImage(this, 'image2');" type="file" class="dropify" data-title="Image-2" id="image2" name="image[]" />
