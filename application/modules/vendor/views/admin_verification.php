                    ...
                    <div class="col-md-6 offset-3">
                        <div class="login-box registr-box">
                            <div class="form-section">
                                ...
                                <h3>Profile is under verification..!!</h3>
                                <p>
                                <span>Please wait for a while until admin don't approve the profile</span></p>
                                <a href="<?php echo site_url('vendor');?>" class="btn btn-primary mybtns-send ">Back to Sign In</a> 
                            </div>
                        </div>
                    </div>
                </div>
