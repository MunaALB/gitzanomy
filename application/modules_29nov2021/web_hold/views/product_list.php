    ...
    <div id="content">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><a style="color:red;" href="<?=base_url('product-subcategory/'.$getViewQueryCat['category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $getViewQueryCat['name'])));?>">
                    ...
                    <div class="products-category">
                        ...
                        <div class="row"> 
                            <div class="col-lg-12 col-md-12 mt-2 text-center">
                                <a style="cursor:default;display:none;color:#fd5000;" id="loading_msg" >..please wait while more products are loading..</a>
                                <a style="cursor:default;text-decoration: underline;" data-page="1" onclick="loadMoreProducts(this)">Load more</a>
                            </div>
                        </div>
                        <?php endif; ?>
