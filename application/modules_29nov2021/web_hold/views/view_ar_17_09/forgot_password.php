                        ...
                        <form action="<?php echo base_url('verify-otp'); ?>" >
                            <div class="col-sm-6 customer-login col-sm-offset-3">
                                ...
                                <div class="bottom-form">
                                    <a href="<?php echo base_url('user-login'); ?>" class="forgot">العودة لتسجيل الدخول</a>
                                    <input type="button" onclick="ForgotPassword(this);" value="إرسال" class="btn btn-default pull-right" />
                                </div>
                            </div>
                        </form>
                    </div>
