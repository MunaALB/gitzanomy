                               ...
                               <?php if($brand_list): foreach($brand_list as $cat): ?>
                                <div class="col-md-2 col-xs-6">
                                    <div class="content-box">
                                        <div class="image-cat">
                                            <a href="<?php echo base_url('product-by-brand/'.$cat['brand_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $cat['name']))); ?>" title="<?=$cat['name_ar'];?>">
                                            <img src="<?=$cat['image'];?>" style="width: 150px;height: 130px;" title="<?=$cat['name_ar'];?>" alt="<?=$cat['name_ar'];?>" />
                                            </a>
                                        </div>
                                        <div class="cat-title"> 
                                          <a href="<?php echo base_url('product-subcategory/'.$cat['brand_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $cat['name']))); ?>" title="<?=$cat['name_ar'];?> "><?=$cat['name_ar'];?></a>
                                        </div>
                                    </div>
                                </div>
                                <?php endforeach; ?>
