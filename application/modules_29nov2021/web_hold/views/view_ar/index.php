    ...
    <div id="content">
        <div class="container">
            <div class="so-categories module custom-slidercates">
                <h3 class="modtitle"><span>فئات المنتجات</span><span class="view-all-part"><a href="<?=base_url('product-category');?>">عرض الجميع</a></span></h3>
                    ...
                    <div class="cat-wrap theme3 font-title">
                        <div class="yt-content-slider" data-rtl="yes" data-autoplay="yes" data-autoheight="no" data-delay="2" data-speed="0.6" data-margin="30" data-items_column0="6" data-items_column1="5" data-items_column2="4"  data-items_column3="2" data-items_column4="3" data-arrows="yes" data-pagination="no" data-lazyload="yes" data-loop="yes" data-hoverpause="yes">
                            ...
                            <div class="content-box">
                                <div class="image-cat">
                                    <a href="<?php echo base_url('product-subcategory/'.$cat['category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $cat['name_ar']))); ?>" title="<?=$cat['name'];?>">
                                        <img src="<?=$cat['image'];?>" title="210 X 210" alt="210 X 210" />
                                    </a>
                                </div>
                                <div class="cat-title"> 
                                  <a href="<?php echo base_url('product-subcategory/'.$cat['category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $cat['name_ar']))); ?>" title="Towels Cloud "><?=$cat['name'];?></a>
                                </div>
                            </div>
                        ...
                        <div class="ltabs-tabs-container" data-rtl="yes" data-delay="300" data-duration="600" data-effect="starwars" data-ajaxurl="" data-type_source="0" data-lg="5" data-md="4" data-sm="2" data-xs="2" data-margin="30">              
                            <div class="ltabs-tabs-wrap">   
                                <ul class="ltabs-tabs cf list-sub-cat font-title">                                  
                                    ...
                                    <span class="view-all-part"><a href="<?=base_url('top-selling-product');?>">عرض الجميع</a></span>
                                </ul>
                            </div>
                        </div>
                                        ...
                                        <div class="item-inner product-layout transition product-grid">
                                            <div class="product-item-container">
                                                ...
                                                <div class="right-block">
                                                    <div class="caption">
                                                        <h4><a href="<?php echo base_url('product-detail/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $fproduct['name_ar'])).'/'.$fproduct['product_id']); ?>" title="Pride Mobility Chair"><?=$fproduct['name'];?></a></h4>
                                ...
                                <div class="ltabs-tabs-container" data-rtl="yes" data-delay="300" data-duration="600" data-effect="starwars" data-ajaxurl="" data-type_source="0" data-lg="5" data-md="4" data-sm="2" data-xs="2" data-margin="30">              
                                    <div class="ltabs-tabs-wrap">   
                                        <ul class="ltabs-tabs cf list-sub-cat font-title">                                  
                                            ...
                                            <span class="view-all-part"><a href="<?=base_url('most-viewed-product');?>">عرض الجميع</a></span>
                                        </ul>
                                    </div>
                                </div>
                                <div class="wap-listing-tabs ltabs-items-container products-list grid">
...
<div class="main-container">
    <div id="content">
        <div class="container">
            <div class="so-categories module custom-slidercates">
                <h3 class="modtitle"><span>فئات الخدمات</span> <span class="view-all-part"><a href="<?=base_url('service-category');?>">عرض الجميع</a></span></h3>
                <div class="modcontent">
                    <div class="cat-wrap theme3 font-title">
                        <div class="yt-content-slider" data-rtl="yes" data-autoplay="no" data-autoheight="no" data-delay="4" data-speed="0.6" data-margin="30" data-items_column0="7" data-items_column1="4" data-items_column2="4"  data-items_column3="2" data-items_column4="3" data-arrows="yes" data-pagination="no" data-lazyload="yes" data-loop="no" data-hoverpause="yes">
                            ...
                            <div class="content-box">
                                <div class="image-cat">
                                    <a href="<?php echo base_url('service-subcategory/'.$cat['category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $cat['name_ar']))); ?>" title="Watches">
                                        <img src="<?=$cat['image'];?>" title="210 X 210" alt="210 X 210" />
                                    </a>
                                </div>
                                <div class="cat-title"> 
                            ...
                            <div class="ltabs-wrap">
                                <div class="ltabs-tabs-container" data-rtl="yes" data-delay="300" data-duration="600" data-effect="starwars" data-ajaxurl="" data-type_source="0" data-lg="5" data-md="4" data-sm="2" data-xs="2" data-margin="30">              <div class="ltabs-tabs-wrap">   
                                        <ul class="ltabs-tabs cf list-sub-cat font-title">                                  
                                            ...
                                            <span class="view-all-part"><a href="<?=base_url('most-booking-service');?>">عرض الجميع</a></span>                                           
                                        </ul>
                                    </div>
                                </div>
                                <div class="wap-listing-tabs ltabs-items-container products-list grid">
                                                        ...
                                                        <div class="product-item-container">
                                                            <div class="left-block">
                                                                <div class="product-image-container second_img">
                                                                    <a href="<?php echo base_url('service-detail/'.$booking['service_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $booking['category_name_ar'])).'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $booking['sub_category_name_ar'])).'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $booking['name_ar']))); ?>" title="<?=$booking['name'];?>">
                                                            ...
                                                            <div class="right-block">
                                                                <div class="caption">
                                                                    <h4><a href="<?php echo base_url('service-detail/'.$booking['service_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $booking['category_name_ar'])).'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $booking['sub_category_name_ar'])).'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $booking['name_ar']))); ?>" title="<?=$booking['name'];?>"><?=$booking['name'];?></a></h4>
