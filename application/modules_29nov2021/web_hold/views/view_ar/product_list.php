    ...
    <div id="content">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><a href="#">فئة المنتج</a></li>
                <li><a href="#">فئة المنتج الفرعية</a></li>
                    ...
                    <div class="products-category">
                        ...
                        <div class="row"> 
                            <div class="col-lg-12 col-md-12 mt-2 text-center">
                                <a style="cursor:default;display:none;color:#fd5000;" id="loading_msg" >..يرجى الانتظار بينما يتم تحميل المزيد من المنتجات..</a>
                                <a style="cursor:default;text-decoration: underline;" data-page="1" onclick="loadMoreProducts(this)">تحميل المزيد</a>
                            </div>
                        </div>
                        <?php endif; ?>
