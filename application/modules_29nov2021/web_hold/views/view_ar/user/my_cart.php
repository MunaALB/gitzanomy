                                    ...
                                    <div class="product-item-container">
                                        <div class="left-block">
                                            <div class="product-image-container second_img">
                                                <a href="<?php echo base_url('product-detail/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $fproduct['name_ar'])).'/'.$fproduct['product_id'].'/'.$fproduct['item_id']); ?>" target="_self" title="<?=$fproduct['name'];?>">
                ...
                <div  class="col-sm-5">
                    <div class="user-rightpart" id="my-cart-cart-total">
                        <h2 class="title">مجموع السلة</h2>
                            ...
                            <div class="buttons">
                                <div class="checkout-btn"><a href="<?php echo base_url('address'); ?>" class="btn btn-primary">الدفع</a></div>
