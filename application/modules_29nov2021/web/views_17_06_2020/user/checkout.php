                                ...
                                <div class="checkout-shipping-methods select-addess">
                                    <div class="panel-body ">
                                        ...
                                        <?php if($getAddress): foreach($getAddress as $key=>$address): ?>
                                                    <?php if($key==0){ ?>
                                                        <div class="col-md-6 addressDiv" data-status="1" data-address="<?=$address['address_id'];?>" onclick="selectAddress(this)">
                                                            <label>
                                                    ...
                                                    <?php } ?>
                                                        ...
                                                        <h5 id="street_address_<?=$key;?>" data-val="<?=$address['street_address'];?>" data-house="<?=$address['house_no'];?>" data-country="<?=$address['country_id'];?>" data-city="<?=$address['city_id'];?>" data-postal="<?=$address['postal_code'];?>"><?=$address['street_address'];?>, <?=$address['house_no'];?>, <?=$address['city'];?>, <?=$address['country_name'];?></h5>
                                                    </div>
