                                    ...
                                    <?php if(isset($category) and $category): foreach($category as $cat): ?>
                                        <div class="col-md-2 col-xs-6">
                                            <div class="content-box">
                                                <div class="image-cat">
                                                    <a href="<?php echo base_url('service-subcategory/'.$cat['category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $cat['name_ar']))); ?>" title="<?=$cat['name'];?>">
                                                        <img src="<?=$cat['image'];?>" title="<?=$cat['name'];?>" alt="210 X 210" />
                                                    </a>
                                                </div>
                                                <div class="cat-title"> 
                                                <a href="<?php echo base_url('service-subcategory/'.$cat['category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $cat['name_ar']))); ?>" title="Salon"><?=$cat['name'];?></a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
