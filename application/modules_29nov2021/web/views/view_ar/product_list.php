    ...
    <div id="content">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <?php
                $cat_query_id=$this->uri->segment(2);
                $sub_cat_query_id=$this->uri->segment(3);
                ...
                <li><a style="color:red;" href="<?=base_url('product-category');?>">
                    <?php if(isset($getViewQueryCat['name_ar']) and $getViewQueryCat['name_ar']){ echo $getViewQueryCat['name_ar']; }else{ echo "Product Category"; } ?></a></li>
                <li><a style="color:red;" href="<?=base_url('product-subcategory/'.$getViewQueryCat['category_id'].'/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $getViewQueryCat['name_ar'])));?>">
                    <?php if(isset($getViewQuerySubCat['name_ar']) and $getViewQuerySubCat['name_ar']){ echo $getViewQuerySubCat['name_ar']; }else{ echo "Product Sub Category"; } ?></a></li>
                    ...
                    <div class="products-category">
                                ...
                                <div class="product-item-container">
                                    <div class="left-block">
                                        <div class="product-image-container <?php if(isset($fproduct['images'][1])): echo "second_img"; endif; ?>">
                                            <a href="<?php echo base_url('product-detail/'.(preg_replace('/[^a-zA-Z0-9_.]/', '-', $fproduct['name_ar'])).'/'.$fproduct['product_id']); ?>" title="<?=$fproduct['name'];?>">
                        ...
                        <div class="row"> 
                            <div class="col-lg-12 col-md-12 mt-2 text-center">
                                ...
                                <a id="loadmoreButton" hidden   style="cursor:default;text-decoration: underline;" data-page="1" onclick="loadMoreProducts(this)">تحميل المزيد</a>
                            </div>
                        </div>
                        <?php endif; ?>
