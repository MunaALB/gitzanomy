                    ...
                    <div class="row">
                        <div class="col-sm-6 new-customer">
                            ...
                            <div class="bottom-form">
                                <a href="<?php echo base_url('user-login'); ?>" class="btn btn-default pull-right"> تسجيل الدخول</a>
                            </div>
                        </div>
                                ...
                                <div class="bottom-form">
                                    <div class="check-icon">
                                       ...
                                       <p> أوافق على <a href="#" class="agree"><b>الأحكام والشروط</b></a></p>
                                        <input type="button" onclick="register(this);" value="سجل" class="btn btn-primary pull-right">
                                    </div>
                                </div>
                            </div>
                        </form>
