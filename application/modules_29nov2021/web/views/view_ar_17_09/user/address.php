                        ...
                        <div class="col-sm-12">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group required">
                                                                    ...
                                                                    <input type="text" onkeypress="return (event.charCode > 47 &amp;&amp;   event.charCode < 58) " id="mobile" name="mobile" class="form-control regInputs" placeholder="رقم الهاتف"  data-title="رقم الهاتف" style="width: 73%;">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group required">
                                                                    ...
                                                                    <input type="text" class="form-control regInputs" onclick="openLocationPicker(this,'1');"  id="geo_address" name="geo_address" data-title="عنوان جغرافي" placeholder="عنوان جغرافي" value="">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group required">
                                                                    ...
                                                                    <input type="text" class="form-control" id="house_no" name="house_no" data-title="رقم المنزل." placeholder="رقم المنزل." value="">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group required">
                                                                    ...
                                                                    <input type="text" class="form-control regInputs" id="street_address" name="street_address" data-title="عنوان الشارع" placeholder="عنوان الشارع" value="">
                                                    ...
                                                    <div class="new-address">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group required">
                                                                    ...
                                                                    <input type="text" onkeypress="return (event.charCode > 47 &amp;&amp;   event.charCode < 58) " id="mobile2" name="mobile2" class="form-control regInputs2" placeholder="رقم الهاتف"  data-title="رقم الهاتف" style="width: 73%;">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group required">
                                                                    <label for="input-payment-address-1" class="control-label">عنوان جغرافي</label>
                                                                    <input type="text" class="form-control regInputs2"  onclick="openLocationPicker(this,'2');"  id="geo_address2" name="geo_address" data-title="عنوان جغرافي" placeholder="عنوان جغرافي" value="">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group required">
                                                                    ...
                                                                    <label for="input-payment-address-1" class="control-label">رقم المنزل.</label>
                                                                    <input type="text" class="form-control" id="house_no2" name="house_no" data-title="رقم المنزل." placeholder="رقم المنزل." value="">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group required">
                                                                    <label for="input-payment-address-1" class="control-label">عنوان الشارع</label>
                                                                    <input type="text" class="form-control regInputs2" id="street_address2" name="street_address" data-title="عنوان الشارع" placeholder="عنوان الشارع" value="">
                                                                    <p class="errorPrint" id="street_address2Error"></p>
                                                                </div>
                                                            </div>
                            ...
                            <?php else: ?>
                                <div class="panel panel-default">
                                    ...
                                    <div class="checkout-shipping-methods select-addess">
                                        <div class="panel-body ">
                                            <p>تسجيل الدخول مع حساب الضيف.</p>
                                            <div class="well">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group required">
                                                                ...
                                                                <input type="text" onkeypress="return (event.charCode > 47 &amp;&amp;   event.charCode < 58) " id="guest_mobile" name="guest_mobile" class="form-control" placeholder="رقم الهاتف"  data-title="رقم الهاتف" style="width: 73%;">
                                                                <p class="errorPrint" id="guest_mobileError"></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="buttons">
                                                        <div class="saveaddress"><a onclick="guestLogin(this);" class="btn btn-primary">Guest Login</a></div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <p class="errorPrint" id="verificationGenericError"></p>
                                                                ...
                                                                <input type="text" onkeypress="return (event.charCode > 47 &amp;&amp;   event.charCode < 58) " id="guest_mobile_otp" name="guest_mobile" class="form-control" placeholder="Enter OTP"  data-title="Otp">
                                                                <p class="errorPrint" id="guest_mobileError"></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="buttons">
                                                        <div class="saveaddress"><a onclick="verifyOtp(this);" class="btn btn-primary">Verify Now</a></div>
                                                    </div>
                                                </div>
                ...
                <div class="user-rightpart checkout-side">
                    <div class="buttons">
                        ...
                        <?php if(isset($user_cart['payble_amount']) and $user_cart['payble_amount']): ?>
                            <?php if($login_type==1):?>
                                <?php if($getAddress): ?>
                                    <div class="checkout-btn"><a href="<?=base_url('checkout');?>" id="placeOrderBtn" data-check="0" class="btn btn-primary">عملية الخروج</a></div>
                                <?php else: ?>
                            ...
                            <?php else: ?>
                                ...
                                <button onclick="placeOrder(this,2);" id="placeOrderBtn" data-check="0" class="button-disabled">عملية الخروج</button></div>
                            <?php endif; ?>
                        <?php else: ?>
...
<script>
    ...
    function verifyOtp(obj){
        ...
        if (mobile) {
                        ...
                        $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if (jsonData['error_code'] == 200) {
                                        swal({title:"Warning.",text: returnObject.message,type: "success"},function(){ 
                                            location.reload();
                                        })
                                    } else {
            ...
            if(mobile){
                swal({title:"تحذير.",text: "*يجب تأكيد الرمز المرسل لهاتفك",type: "warning"})
            }else{
                swal({title:"تحذير.",text: "*البريد الإلكتروني (مطلوب",type: "warning"})
            }
        }
    }
    ...
    function addAddress(obj){
        ...
        if (idValidate) {
            ...
            if(getLat && getLng){
                ...
                swal({title:"Warning.",text: "لم يتم التوصيل ، يرجى تحديد العنوان الجغرافي.",type: "warning"})
            }
        }
    }
    ...
    function editAddress(obj){
        ...
        if (idValidate) {
            ...
            if(getLat && getLng){
                ...
                swal({title:"تحذير.",text: "لم يتم التوصيل ، يرجى تحديد العنوان الجغرافي.",type: "warning"})
            }
        }
    }
    ...
    function placeOrder(o,t){
        if(t==1){
            showErrorMessage('PaymentError',"*يرجى اضافة العنوان الخاص بك ..");
        }else if(t==2){
            showErrorMessage('PaymentError',"*الرجاء تسجيل الدخول أولا");
        }else{
            showErrorMessage('PaymentError',"*حدث خطأ ما. حاول مجددا.");
        }
    }
