                                            ...
                                            <div class="well">
                                                <div class="new-address" >
                                                    ...
                                                    <div class="buttons" style="display: inline;position: absolute;margin-left: 172px;margin-top: -42px;">
                                                        <div class="saveaddress"><a href="<?=base_url('user-login');?>" class="btn btn-primary">Login With Mobile</a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="user-rightpart checkout-side">
                    <div class="buttons">
                        ...
                        <?php if(isset($user_cart['payble_amount']) and $user_cart['payble_amount']): ?>
                            <?php if($login_type==1):?>
                                <?php if($getAddress): ?>
                                    <div class="checkout-btn"><a href="<?=base_url('checkout');?>" id="placeOrderBtn" data-check="0" class="btn btn-primary">Checkout & Process</a></div>
                                <?php else: ?>
