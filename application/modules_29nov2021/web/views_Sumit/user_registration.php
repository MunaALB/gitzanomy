                    ...
                    <div class="row">
                        <div class="col-sm-6 new-customer">
                            ...
                            <div class="bottom-form">
                                <a href="<?php echo base_url('user-login'); ?>" class="btn btn-default pull-right">Continue With Login</a>
                            </div>
                        </div>
                        <form action="<?php echo base_url(''); ?>" >
                            <div class="col-sm-6 customer-login">
                                ...
                                <div class="bottom-form">
                                    <div><input id="t_n_c" class="box-checkbox" type="checkbox" name="agree" value="1"> &nbsp;
                                        I agree to the <a href="#" class="agree"><b>terms & conditions</b></a>
