                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="price"> <span class="price-new">Approved</span></div>
                                            
                                            </td>
                                            <td class="text-center">
                                                <a class="btn btn-danger" title="" href="<?php echo base_url('request-detail'); ?>" data-original-title="View"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-danger" title="" href="<?php echo base_url('request-detail'); ?>" data-original-title="View"><i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
