                        ...
                        <div class="row">
                            <div class="col-sm-6 new-customer">
                                ...
                                <div class="bottom-form">
                                    <a href="<?php echo base_url('user-registration'); ?>" class="btn btn-default pull-right">Continue With Registration</a>
                                </div>
                            </div>
                            ...
                            <form action="<?php echo base_url(''); ?>" >
                                <div class="col-sm-6 customer-login">
                                    ...
                                    <div class="bottom-form">
                                        <a href="<?php echo base_url('forgot-password'); ?>" class="forgot">Forgotten Password</a>
