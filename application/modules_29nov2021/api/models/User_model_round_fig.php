...
//                print_r($productAttribute);EXIT;
    ...
    function homepage($data,$langData){
        ...
        return array('slider'=>$slider,'productCategory'=>$productCategoryArr,'mostViewsProducts'=>$mostViewsProductsArr,'topSellingProducts'=>$topSellingProductsArr,'serviceCategory'=>$serviceCategory,'mostBooking'=>$topBookingServiceArr,'user_status'=>$userStatus);
    }
