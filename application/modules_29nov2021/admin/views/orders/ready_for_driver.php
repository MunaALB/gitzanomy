            ...
            <div class="">
                <div id="demo">
                    <div class="step-app order-tabs">
                        <ul class="step-steps">
                            <li class="active"><a href="#step1">Item Dessssssssssstail</a></li>
                                ...
                                <div class="card-body">
                                    <div class="eventrow">
                                        <div class="item-detail-buttons">
                                            ...
                                            <button type="button" class="btn btn-secondary">Get an item</button>
                                            <button type="button" class="btn btn-secondary active">Ready for Delivery</button>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card m-b-3 order-productss">
                                            ...
                                            <div class="item-order-status">
                                                <div class="status-part">
                                                    <ul>
                                                        <li class="completed">Awaiting Confirmation</li>
                                                        <li class="cancel-item">Cancel</li>
                                                        <li>Dispatch</li>
                                                        <li>Delivered</li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="assign-driver-link"><a href="#" >View Cancellation reason</a> <a href="javascript:void(0)" id="adddriverlist">Assign a Driver</a></div>
                                        </div>
                                        <div class="card m-b-3 order-productss">
                                            <div class="card-body">
                                                <div class="row">
