                        ...
                        <div class="step-content for-border-remove">
                            <div class="step-tab-panel active" id="step1">
                                <?php  
                                    ...
                                    // $getFromVendor='<a href="'.base_url('admin/new-order-detail/'.$order['order_id']).'" class="btn btn-secondary">Get an item</a>';
                                    $getFromVendor='<a href="#" class="btn btn-secondary">Get an item</a>';
                                ...
                                <div class="card-body">
                                   ...
                                   <?php if($order['upfront_tracking_id']){ ?>
                                ...
                                <div class="order-products-list">
                                    <div class="card-body">
                                        ...
                                        <div class="card m-b-3 order-productss">
                                            ...
                                            <?php if(isset($items['drop_item_status_count']) and $items['drop_item_status_count']): if(isset($items['drop_driver_order']['driver_order_status']) and $items['drop_driver_order']['driver_order_status']==3){ ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5>
                            ...
                            <button type="button" id="assignForUpfrontAmount" onclick="assignForUserPorduct(this,'<?=$order['order_id'];?>');" class="btn btn-secondary active btn-new">Save</button>
                            </div>
