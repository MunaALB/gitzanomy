...
.vendor-admin-buttons .items-tabs-for-return {
    width: 47% !important;
}
</style>
<div class="content-wrapper">
                    ...
                    <div class="step-app order-tabs">
                        ...
                        <div class="step-content for-border-remove">
                            <div class="step-tab-panel active" id="step1">
                                <div class="card-body">
                                    <div class="eventrow">
                                        <div class="vendor-admin-buttons">
                                            <button type="button" class="btn btn-secondary active items-tabs-for-return new-class" onclick="returnDataDiv(this,'1','receiverOnHubDiv');">Get Product On Hub</button>
                                            <button type="button" class="btn btn-secondary items-tabs-for-return new-class" onclick="returnDataDiv(this,'2','DropOnVendorDiv');">Drop Product On Vendor Location</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="card m-b-3  return-item-div" id="receiverOnHubDiv" style="">
                                    <?php  
                                    ...
                                    <div class="order-products-list">
                                        ...
                                        <div class="card-body">
                                            <div class="card m-b-3 order-productss" id="inventoryItemDiv" style="">
                                                <?php if(isset($order['inventory_items']) and $order['inventory_items']): foreach ($order['inventory_items'] as $key => $items): ?>
                                                <div class="card m-b-3 ">
                                                    <?php 
                                                        if($items['return_tracking_id']==0){ ?>
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <input type="checkbox" onchange="checkOrderDataInventory(this,'<?=$order['order_id'];?>');" class="item_class_inventory item_class_css" value="<?=$items['order_item_id'];?>" name="select_item_inventory">
                                                            </div>
                                                        </div>
                                                    <?php  } ?>
                                                    <div class="card-body">
                                                    ...
                                                    <?php if(isset($items['drop_driver_order']['driver_order_status']) and $items['drop_driver_order']['driver_order_status']==3){ ?>
                                                            <div class="verify-admin">
                                                                <a onclick="receivedOnHub(this,'<?=$items['order_id']?>','<?=$items['return_driver_id']?>','<?=$items['return_tracking_id']?>','1');" style="background: #ef4e32;cursor:pointer;color:#fff;">Verified by Admin</a>
                                                            </div>
                                                        <?php }else{ ?>
                                                            <div class="verify-admin">
                                                        ...
                                                        <?php }  ?>
                                                    <?php if($items['is_return_in_hub']==0){
                                                            if($items['return_tracking_id']==0){ ?>
                                                ...
                                                <?php endforeach; else : echo "No Items Available..."; endif; ?>
                                        </div>
                                            ...
                                            <div  id="internationalItemDiv" class="order-productss" style="display:none;">
                                                <?php if(isset($order['international_items']) and $order['international_items']): foreach ($order['international_items'] as $key => $items): ?>
                                                <div class="card m-b-3 ">
                                                    <?php 
                                                        if($items['return_tracking_id']==0){ ?>
                                                        <div class="card-body">
                                        ...
                                        <div class="order-productss" id="vendorItemDiv" style="display:none;">
                                            <?php if(isset($order['vendor_items']) and $order['vendor_items']): foreach ($order['vendor_items'] as $key => $items): ?>
                                            <div class="card m-b-3">
                                                <?php 
                                                    if($items['return_tracking_id']==0){ ?>
                                                    <div class="card-body">
                                ...
                                <div class="card m-b-3  return-item-div" id="DropOnVendorDiv" style="display:none;">
                                    <div class="" id="vendorItemDivDrop" style="">
                                    <div class="card-body">
                                        <div class="eventrow">
                                            <div class="assign-driver-buttons" id="assignedByDriverVendorReturnDiv">
                                                <a href="javascript:void(0)" style="cursor: not-allowed;" class="btn btn-secondary">Assign a Driver</a>
                                            </div>
                                        </div>
                                    </div>
                                        <?php if(isset($order['vendor_items']) and $order['vendor_items']): foreach ($order['vendor_items'] as $key => $items): ?>
                                            <?php if($items['is_return_in_hub']!=0){ ?>
                                                <div class="card m-b-3">
                                                    <?php 
                                                        if($items['return_drop_tracking_id']==0){ ?>
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <input type="checkbox" onchange="checkOrderDataVendorDrop(this,'<?=$order['order_id'];?>');" class="item_class_inventory item_class_css" value="<?=$items['order_item_id'];?>" name="select_item_vendor_drop">
                                                            </div>
                                                        </div>
                                                    <?php  } ?>
                                                    <div class="card-body">
                                                    ...
                                                    <div class="item-order-status">
                                                        <div class="status-part"> 
                                                        <?php $width=30; if(isset($items['return_drop_item_status_count']) and $items['return_drop_item_status_count']):
                                                            $width=(100/$items['return_drop_item_status_count']); endif;?>
                                                            <ul>
                                                                <?php $isJobDoneDriver=true; if(isset($items['return_drop_item_status']) and $items['return_drop_item_status']): 
                                                                    foreach($items['return_drop_item_status'] as $status): ?> 
                                                                        <?php if($status['is_checked']==1):?>
                                                                            <li class="completed" title="<?=$status['tracker_date']?>" style="width:<?=$width;?>%"><?=$status['order_status'];?></li>
                                                                        <?php else: $isJobDoneDriver=false; ?>
                                                                            <li class="" title="Not Update" style="width:<?=$width;?>%"><?=$status['order_status'];?></li>
                                                        ...
                                                        <?php if($items['is_return_drop']==0){
                                                                ...
                                                                <div class="oredr-lable"><p>Return TO Vendor</p></div>
                                                        <?php  } ?>
                                                    </div>
                                                    <?php if(isset($items['return_drop_driver_order']['driver_order_status']) and $items['return_drop_driver_order']['driver_order_status']==3){ ?>
                                                        <div class="verify-admin">
                                                            <a onclick="receivedOnHub(this,'<?=$items['order_id']?>','<?=$items['return_drop_driver_id']?>','<?=$items['return_drop_tracking_id']?>','2');" style="background: #ef4e32;cursor:pointer;color:#fff;">Verified by Admin</a>
                                                        </div>
                                                    <?php }else{ ?>
                                                        <div class="verify-admin">
                                                            <a  style="cursor:not-allowed">Verified by Admin</a>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5>
                            ...
                            <button type="button" id="assignForUpfrontAmount" onclick="assignForInventoryPorduct(this,'<?=$order['order_id'];?>');" class="btn btn-secondary active btn-new">Save</button>
                            </div>
    ...
    <script type="text/javascript">
        function returnDataDiv(o,t,i){
            $(".new-class").removeClass('active');
            $(o).addClass('active');
            $(".return-item-div").css('display','none');
            $("#"+i).css('display','block');
        }
    </script>
    <script type="text/javascript">
        function checkOrderDataInventory(o,t){
            var select_item=$('input[name="select_item_inventory"]:checked').val();
            ...
            if(select_item==undefined || select_item=='undefined'){
                ...
                $("#assignedByDriverDiv").empty();
                $("#assignedByDriverDiv").append('<a href="javascript:void(0)" onclick="inventoryDriverListShow(this,\''+t+'\',1);" data-type="1" class="btn btn-secondary activeButton">Assign a Driver</a>');
            }
        }

        function inventoryDriverListShow(o,t,oid){
            var attrData=$(o).attr('data-type');
            $("#listdriver").addClass("active");
            $("#assignForUpfrontAmount").attr('data-type',oid);
        }
        function assignForInventoryPorduct(obj,orderId) {
            var newData='';
            var driver_id=$('#assignForUpfrontAmount').attr('data-driver');
            var type=$('#assignForUpfrontAmount').attr('data-type');
            if(driver_id==undefined || driver_id=='undefined'){
                alert("Please select a driver.");
            }else{
                if (orderId) {
                    $('.item_class_inventory:checked').each(function(index, value){
                        if ($(this).val()) {
                            if(newData){
                    ...
                    if(type==1){
                        $.ajax({
                            ...
                            type: 'post',
                            data: 'method=assignForReturnTracking&driverId=' + driver_id + '&orderId=' + orderId+ '&itemId=' + newData,
                        ...
                        $.ajax({
                            url: "<?= base_url(); ?>admin/Order/ajax_method",
                            type: 'post',
                            data: 'method=assignForDropReturnTracking&driverId=' + driver_id + '&orderId=' + orderId+ '&itemId=' + newData,
                            success: function (data) {
                                var dt = $.trim(data);
                                var jsonData = $.parseJSON(dt);
                                if (jsonData['error_code'] == "100") {
    ...
    <script type="text/javascript">
        function checkOrderDataVendorDrop(o,t){
            var select_item=$('input[name="select_item_vendor_drop"]:checked').val();
            
            if(select_item==undefined || select_item=='undefined'){
                $("#assignedByDriverVendorReturnDiv").empty();
                $("#assignedByDriverVendorReturnDiv").append('<a href="javascript:void(0)" style="cursor: not-allowed;" class="btn btn-secondary">Assign a Driver</a>');
            }else{
                $("#assignedByDriverVendorReturnDiv").empty();
                $("#assignedByDriverVendorReturnDiv").append('<a href="javascript:void(0)" onclick="inventoryDriverListShow(this,\''+t+'\',2);" data-type="1" class="btn btn-secondary activeButton">Assign a Driver</a>');
            }
        }
        ...
        function receivedOnHub(obj,o,d,t,type){
            ...
            if (r == true) {
                $.ajax({
                        url: "<?= base_url(); ?>admin/Order/ajax_method",
                        type: 'post',
                        data: 'method=receivedOnHubReturnItem&orderId=' + o+'&driverId='+d+'&tracking_id='+t+'&type='+type,
                        success: function (data) {
                            var dt = $.trim(data);
                            var jsonData = $.parseJSON(dt);
                            if (jsonData['error_code'] == "100") {
