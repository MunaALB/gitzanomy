                                            ...
                                            <?php }elseif($items['product_from']==2){ ?>
                                                ...
                                                <div class="card m-b-3 order-productss" id="internationalItemDiv" style="display:none;">
                                                    <?php if($items['is_in_hub']==0){ ?>
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <input type="checkbox" onchange="checkOrderData(this,'<?=$order['order_id'];?>');" class="item_class item_class_css" value="<?=$items['order_item_id'];?>" name="select_item_international">
                                                            </div>
                                                        </div>
                                                    <?php } ?>
                                                    <div class="card-body">
