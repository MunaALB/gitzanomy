            ...
            <div class="col-lg-8">
                <?php if ($order['order_items']): ?>
                    <?php   
                        ...
                        $readyForDelivery='<a style="cursor:pointer;" onclick="checkOrderData(this);" title="Upfron Order" class="composemail assign-driver pull-left">Ready for delivery</a>';
                    ?>
                    ...
                    <?php foreach ($order['order_items'] as $key => $items): ?>
                        <div class="card m-b-3">
                            ...
                            <?php endif; ?>
                            <div class="order-status">
                                <?php if($items['drop_item_status_count']>0):?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php if($driver_list): ?>
                        ...
                        <a class="composemail pull-right" onclick="assignForUserPorduct(this,'<?=$order['order_id'];?>');" style="cursor:pointer;">Assign</a>
                    <?php else:?>
                        <div class="content">
                            <div class="driver-lists">
                                <div class="row">
