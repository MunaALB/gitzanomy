                ...
                <div class="col-lg-8">
                    <div class="card m-b-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-4">
                                    <a  class="composemail assign-driver pull-right disabled-btn"> Assign For Upfront</a>
                                </div>
                            ...
                            <?php endif; ?>
                                <div class="col-lg-4">
                                    ...
                                    <?php else: ?>
                                        <a href="<?=base_url('admin/assigned-driver-for-user-product/'.$order['order_id']);?>" class="composemail assign-driver pull-left">Ready for delivery</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="order-status">
                                    <div class="status-part">
                                        ...
                                        <?php if($items['user_status']==5){
                                            ...
                                            <?php
                                        }else{ $completedClass="";$activeClass=""; for($i=1;$i<=4;$i++): 
                                                if($i==1){
