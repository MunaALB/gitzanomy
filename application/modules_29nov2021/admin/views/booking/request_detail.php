                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                <div class="mail-contnet">
                                    ...
                                    <br>
                                    <small><a title="view vendor detail" href="<?php echo base_url('admin/vendor-detail/' . $booking['vendor_id']); ?>"><?= ucwords($booking['vendor_name']) ?></a></small>
                                    ...
                                    <div class="view-detail"><a href="<?php echo base_url('admin/vendor-service-detail/' . $booking['service_id']); ?>">View Service</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="order-status">
                        <?php if ($booking['status'] == 0) { ?>
                            <div class="box-profile">
                                <h3 class="profile-username text-center">Pending Request</h3>
                            </div>
                        ...
                        <?php } else { ?>
                            <div class="status-part">
                                <ul>
                                    ...
                                    <li class="<?= $booking['status'] < 2 ? '' : ($booking['status'] == 2 ? 'active' : 'completed') ?>">On The Way</li>
                                    <li class="<?= $booking['status'] < 3 ? '' : ($booking['status'] == 3 ? 'active' : 'completed') ?>">In Process</li>
                                    <li class="<?= $booking['status'] < 4 ? '' : ($booking['status'] == 4 ? 'active' : 'completed') ?>">Completed</li>
                                </ul>
                            </div>
                        <?php } ?>
                    </div>
                ...
                <div class="box box-primary m-b-3">
                    <div class="box-profile">
                        ...
                        <ul class="nav nav-stacked sty1">
                            <li><strong>Request Date:</strong> <span class="pull-right"><?= date('d-m-Y h:i A', strtotime($booking['created_at'])) ?></span></li>
