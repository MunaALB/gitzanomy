        ...
        <div class="card">
            ...
            <div class="card-body"> 
             ...
             <div class="col-md-12">
                ...
                <input type="file" id="input-file-now-custom-1" name="image" class="dropify stepError1" data-warning="errorWarning3" accept="image/*"/> 
                <?= form_error('image') ?>
    ...
    <?php } else { ?>
        ...
        <div class="card">
            ...
            <div class="card-body"> 
             ...
             <div class="col-md-12">
                <label for="validationCustom01">Brand Image</label>
                <input type="file" id="input-file-now-custom-1" value="<?php echo $edit['image']; ?>" name="image_update" data-default-file="<?php echo $edit['image'];?>" class="dropify" accept="image/*"/> 
                <button type="button" class="composemail mt-4 pull-right" data-count="1" onclick="nextt(this, 1)">Update</button>  
                </div>
                </div>
            </div>
        </form>
...
<script type="text/javascript">errorMsg
