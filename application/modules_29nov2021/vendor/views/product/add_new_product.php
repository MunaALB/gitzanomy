                        ...
                        <div class="row m-t-2">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="file" accept="image/*" class="dropify regInputs" data-title="Image-1" id="image1" name="image[]" />
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input  type="file" accept="image/*" class="dropify" data-title="Image-2" id="image2" name="image[]" />
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="file" accept="image/*" class="dropify" data-title="Image-3" id="image3" name="image[]" />
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input  accept="image/*" type="file" class="dropify" data-title="Image-4" id="image4" name="image[]"/>
...
//        $('.p_spec').trigger('chosen:updated');
    ...
    function addProduct(o) {
        ...
        $( ".dropify" ).each(function( index,value ) {
                ...
                var newData=validImage(index,idImg);
                if(newData=="fail"){
                    idValidate=true;
                }
            });
