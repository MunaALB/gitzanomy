...
<html lang="eng" dir="rtl">
    ...
    <body class="login-page sty1">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="form-section">
                        ...
                        <p> 
                        استعادة كلمة المرور الخاصة بك عن طريق التحقق من عنوان البريد الإلكتروني المسجل</p>
                        ...
                        <form id="login_form" method="post">
                            <div class="form-group">  
                                ...
                                <input type="email" name="email" class="form-control" placeholder="عنوان البريد الالكترونى"> 
                            </div>   
                            <a style="cursor:pointer;" onclick="validate(this);" class="btn btn-primary mybtns-send ">إرسال</a>
                        </form>
                    </div>
                        </div>
                    </div>
        ...
        <div class="modal fade modal-design" id="exampleModal" data-keyboard="false" data-backdrop="static"data-keyboard="false" data-backdrop="static"data-keyboard="false" data-backdrop="static"data-keyboard="false" data-backdrop="static"data-keyboard="false" data-backdrop="static"data-keyboard="false" data-backdrop="static"data-keyboard="false" data-backdrop="static"data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="otp_form" method="post">
                            ...
                            <label><a style="cursor:pointer;" onclick="resend();" id="resendBtn"> ألم تتلق رمز التحقق؟ أعد إرسال الرمز</a> </label>
                                ...
                                function verifyOtp(obj) {
                                    ...
                                    if (flag) {
                                        $.ajax({
                                            ...
                                            type: 'POST',
                                            data: $("#otp_form").serialize() + '&email=' + ($('input[name=email]').val()) + '&type=3',
                                            success: function (data) {
                                                var dt = $.trim(data);
                                                var jsonData = $.parseJSON(dt);
                                                if (jsonData['error_code'] == 100) {
                                                    ...
                                                    window.location.href = "<?= base_url() ?>vendor/reset-password";
                                                } else {
