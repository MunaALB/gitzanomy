                        ...
                        <?php } else { ?>
                            <div class="status-part">
                                <ul>
                                    ...
                                    <li class="<?= $booking['status'] < 2 ? '' : ($booking['status'] == 2 ? 'active' : 'completed') ?>" <?php if ($booking['status'] < 4) { ?>onclick="checkStatus(this, <?= $booking['booking_id'] ?>, 2);" <?php } ?>>علي الطريق</li>
                                    <li class="<?= $booking['status'] < 3 ? '' : ($booking['status'] == 3 ? 'active' : 'completed') ?>" <?php if ($booking['status'] < 4) { ?>onclick="checkStatus(this, <?= $booking['booking_id'] ?>, 3);" <?php } ?>>تحت المعالجة</li>
                                    <li class="<?= $booking['status'] < 4 ? '' : ($booking['status'] == 4 ? 'active' : 'completed') ?>" <?php if ($booking['status'] < 4) { ?>onclick="checkStatus(this, <?= $booking['booking_id'] ?>, 4);" <?php } ?>>تم إنجاز الخدمة</li>
                                </ul>
                            </div>
                        <?php } ?>
                    </div>
