                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="mail-contnet">
                                            <h4 class="text-black m-b-0"><?= $items['product_name_ar'] ?></h4>
                                            <small><?= $items['category_name_ar'] ?></small>
                                            <div class="product-price"> 
                                                <span class="price-new"><?= number_format($items['amount'], 2) ?> LYD</span>
                                                <span class="price-old"><?= number_format($items['price'], 2) ?> LYD</span>
                                            </div>
                                            <p title="Phone">كمية:<span> <?= $items['quantity'] ?> </span></p>
                                            <div class="view-detail"><a href="<?php echo base_url('vendor/product-detail/' . $items['product_id']); ?>">عرض المنتج</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="box box-primary m-b-3">
                    <div class="box-profile">
                        ...
                        <ul class="nav nav-stacked sty1">
                            <li><strong>إجمالي المنتجات:</strong> <span><?= $order['items_count'] ?> العنصر</span></li>
                            <li><strong>تاريخ الطلب:</strong> <span><?= date('d-m-Y', strtotime($order['created_at'])) ?></span></li>
                            <li><strong>طريقة الدفع:</strong> <span><?= $order['payment_type'] == 1 ? 'COD' : 'Online' ?></span></li>         
                            <li><strong>إجمالي الخصم:</strong> <span><?= number_format($order['discount'], 2) ?> LYD</span></li>
                            <li><strong>السعر الكلي:</strong> <span><?= number_format($order['items_total'], 2) ?>  LYD</span></li>
