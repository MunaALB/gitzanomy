            ...
            <div class="card-body">
                ...
                <div class="eventrow">
                    ...
                    <form id="edit_profile" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-5">
                            <div class="col-lg-6 col-xs-6 b-r offset-3 "> 
                                ...
                                <div class="widget-user-image"> 
                                    ...
                                    <label class="btn btn-default btn-sm  mt-2" for="imageUpload">تحميل الصورة</label>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-xs-6 b-r offset-3"> <label>اسم البائع بالكامل : </label> 
                                <span id="name" class="text-danger"></span>
                                <input type="text" class="form-control" name="name" value="<?= $vendor['name'] ?>" placeholder="اسم البائع بالكامل">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-2 col-xs-2 b-r offset-3"> <label>الرقم الدولي : </label>
                               <input type="text" class="form-control" readonly="" value="+218" style="cursor:no-drop">
                            </div> 
                            <div class="col-lg-4 col-xs-4 b-r"> <label>رقم الهاتف المحمول : </label>
                                <span id="mobile" class="text-danger"></span>
                                <input type="text" class="form-control" name="mobile" value="<?= $vendor['mobile'] ?>" placeholder="رقم الهاتف المحمول">  
                            </div> 
                        </div> 
                        <?php if ($vendor['business_type'] == 2) : ?>
                            <div class="row">
                                <div class="col-lg-6 col-xs-6 offset-3">
                                <label>وقت توفير العمل </label>
                                </div>
                                <div class="col-lg-3 col-xs-3 b-r offset-3">
                                    <label>من : </label>
                                    <span id="start_time" class="text-danger"></span>
                                    <div class="form-group">
                                        <input type="time" name="start_time" value="<?= $vendor['start_time'] ?>" class="form-control" placeholder="من" />                                                
                                    </div>
                                </div>
                                <div class="col-lg-3 col-xs-3 b-r">
                                    ...
                                    <div class="form-group">
                                        <input type="time" name="end_time" value="<?= $vendor['end_time'] ?>" class="form-control" placeholder="الى" />
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-xs-6 b-r offset-3"> 
                                <div class="mt-3 mb-4 pull-right">
                                    <button style="cursor:pointer;" type="button" onclick="validate();" id="submitBtn" class="composemail ">إرسال</button>
                                </div>
                            </div>
                        </div>   
                    </form>
                                        ...
                                        function validImage(obj, i) {
                                            ...
                                            img.onload = function () {
                                                ...
                                                if ((200 <= wid && wid <= 250) && (200 <= ht && ht <= 250)) {
                                                    ...
                                                    $('#image1').html('أبعاد الصورة المفضلة 200 × 200 بكسل');
