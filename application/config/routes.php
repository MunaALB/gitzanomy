...
$route['user/searchProductWithCategory']    = 'api/UserApi/searchProductWithCategory';
...
$route['user/orderPayment']                 = 'api/UserApi/orderPayment';
...
$route['user/returnOrderProduct']           = 'api/UserApi/returnOrderProduct';
$route['user/help_n_support']               = 'api/UserApi/help_n_support';
$route['user/notification']                 = 'api/UserApi/notification';


$route['user/transactionList']              = 'api/UserApi/transactionList';

$route['user/getNotes']                     = 'api/UserApi/getNotes';


$route['user/test']        = 'api/UserApi/test';
//----------------------------- Web Services For User --------------------------------//
...
$route['driver/itemReturnPickUpFromUserDetail']      = 'api/DriverApi/itemReturnPickUpFromUserDetail';
$route['driver/itemReturnDropToVendorDetail']      = 'api/DriverApi/itemReturnDropToVendorDetail';
...
$route['vendor/edit-bulk-upload-product']     = 'vendor/Bulk/edit_bulk_upload_product';
...
//====================================English Route//////////////////////////////
$route['en']                                            = 'web';
$route['en/user-login']                                 = 'web/web/user_login';
$route['en/user-registration']                          = 'web/web/user_registration';
$route['en/forgot-password']                            = 'web/web/forgot_password';
$route['en/reset-password']                             = 'web/web/reset_password';

$route['en/product-category']                                      = 'web/web/product_category';
$route['en/product-subcategory/(:num)/(:any)']                     = 'web/web/product_subcategory';
$route['en/product-list/(:num)/(:num)/(:any)']                     = 'web/web/product_list';
$route['en/product-detail/(:any)/(:num)']                          = 'web/web/product_detail';
$route['en/product-detail/(:any)/(:num)/(:num)']                   = 'web/web/product_detail';
$route['en/product-detail/(:any)/(:num)/(:num)/(:num)']            = 'web/web/product_detail';
$route['en/product-detail/(:any)/(:num)/(:num)/(:num)/(:num)']     = 'web/web/product_detail';

$route['en/quick-view-product-detail/(:any)/(:num)']               = 'web/web/quick_view_product_detail';
$route['en/quick-view-product-detail/(:any)/(:num)/(:num)']        = 'web/web/quick_view_product_detail';

$route['en/top-selling-product']                                   = 'web/web/top_selling_product';
$route['en/most-viewed-product']                                   = 'web/web/most_viewed_product';
$route['en/search-product/(:any)']                                 = 'web/web/search_product';
$route['en/most-booking-service']                                  = 'web/web/most_booking_service';

//////////////////////////////USER PROFILE////////////////////
$route['en/my-account']            = 'web/User/my_account';
$route['en/checkout']              = 'web/User/checkout';
$route['en/edit-profile']          = 'web/User/edit_profile';
$route['en/change-password']       = 'web/User/change_password';
$route['en/upload-image']          = 'web/User/upload_image';
$route['en/user-transaction']      = 'web/User/user_transaction';
//////////////////////////COOKIE//////////////////////////////
$route['en/my-cart']               = 'web/Web/my_cart';
$route['en/address']               = 'web/Web/address';
//////////////////////////COOKIE//////////////////////////////

$route['en/my-favourite-product']  = 'web/User/my_favourite_product';
$route['en/booking-transaction-updated']      = 'web/Booking/booking_transaction_updated';
$route['en/order-success']               = 'web/Web/order_success';
$route['en/order-success/(:num)']               = 'web/Web/order_success';
$route['en/success']               = 'web/User/success';
$route['en/success/(:num)']               = 'web/User/success';
$route['en/failure']               = 'web/User/failure';
$route['en/booking-success']       = 'web/Web/booking_success';
$route['en/booking-failure']       = 'web/User/booking_failure';
$route['en/order-history']         = 'web/User/order_history';
$route['en/order-detail/(:num)']   = 'web/User/order_detail';
$route['en/my-request']            = 'web/User/my_request';
$route['en/request-detail/(:num)'] = 'web/User/request_detail';
$route['en/booking-history']       = 'web/User/booking_history';
$route['en/booking-detail/(:num)'] = 'web/User/booking_detail';
$route['en/user-bill/(:num)']             = 'web/User/user_bill';
$route['en/my-notebook']             = 'web/User/my_notebook';
$route['en/logout']                = 'web/User/logout';
//////////////////////////////USER PROFILE////////////////////
//////////////////////////////Service Module////////////////////

$route['en/service-category']                          = 'web/web/service_category';
$route['en/service-subcategory/(:num)']                = 'web/web/service_subcategory';
$route['en/service-subcategory/(:num)/(:any)']         = 'web/web/service_subcategory';
$route['en/service-provider/(:num)']                   = 'web/web/service_provider';
$route['en/service-provider/(:num)/(:any)']            = 'web/web/service_provider';
$route['en/service-provider/(:num)/(:any)/(:any)']     = 'web/web/service_provider';
$route['en/service-list/(:num)/(:num)']                = 'web/web/service_list';
$route['en/service-list/(:num)/(:num)/(:any)']         = 'web/web/service_list';
$route['en/service-list/(:num)/(:num)/(:any)/(:any)']  = 'web/web/service_list';
$route['en/service-list/(:num)/(:num)/(:any)/(:any)/(:any)']= 'web/web/service_list';
$route['en/service-detail/(:num)']                     = 'web/web/service_detail';
$route['en/service-detail/(:num)/(:any)']              = 'web/web/service_detail';
$route['en/service-detail/(:num)/(:any)/(:any)']       = 'web/web/service_detail';
$route['en/service-detail/(:num)/(:any)/(:any)/(:any)']= 'web/web/service_detail';
$route['en/brand-list']                                = 'web/web/brand_list';
$route['en/product-by-brand/(:num)']                   = 'web/web/product_by_brand';
$route['en/product-by-brand/(:num)/(:any)']            = 'web/web/product_by_brand';
$route['en/product-review/(:num)/(:num)/(:any)']      = 'web/web/product_review';
//////////////////////////////Service Module////////////////////

$route['en/my-transaction']  = 'web/web/my_transaction';

$route['en/about-us']  = 'web/web/about_us';
$route['en/privacy-policy']  = 'web/web/privacy_policy';
$route['en/terms-and-condition']  = 'web/web/terms_and_condition';
$route['en/how-it-work']  = 'web/web/how_it_work';
$route['en/contact-us']  = 'web/web/contact_us';
$route['en/faq']  = 'web/web/faq';


$route['en/mobile-about-us']  = 'web/web/mobile_about_us';
$route['en/mobile-privacy-policy']  = 'web/web/mobile_privacy_policy';
$route['en/mobile-terms-and-condition']  = 'web/web/mobile_terms_and_condition';
$route['en/mobile-faq']  = 'web/web/mobile_faq';

//====================================English Route//////////////////////////////
//====================================Arabic Route//////////////////////////////
$route['ar']                                            = 'web';
$route['ar/user-login']                                 = 'web/web/user_login';
$route['ar/user-registration']                          = 'web/web/user_registration';
$route['ar/forgot-password']                            = 'web/web/forgot_password';
$route['ar/reset-password']                             = 'web/web/reset_password';

$route['ar/product-category']                                      = 'web/web/product_category';
$route['ar/product-subcategory/(:num)/(:any)']                     = 'web/web/product_subcategory';
$route['ar/product-list/(:num)/(:num)/(:any)']                     = 'web/web/product_list';
$route['ar/product-detail/(:any)/(:num)']                          = 'web/web/product_detail';
$route['ar/product-detail/(:any)/(:num)/(:num)']                   = 'web/web/product_detail';
$route['ar/product-detail/(:any)/(:num)/(:num)/(:num)']            = 'web/web/product_detail';
$route['ar/product-detail/(:any)/(:num)/(:num)/(:num)/(:num)']     = 'web/web/product_detail';

$route['ar/quick-view-product-detail/(:any)/(:num)']               = 'web/web/quick_view_product_detail';
$route['ar/quick-view-product-detail/(:any)/(:num)/(:num)']        = 'web/web/quick_view_product_detail';

$route['ar/top-selling-product']                                   = 'web/web/top_selling_product';
$route['ar/most-viewed-product']                                   = 'web/web/most_viewed_product';
$route['ar/search-product/(:any)']                                 = 'web/web/search_product';
$route['ar/most-booking-service']                                  = 'web/web/most_booking_service';

//////////////////////////////USER PROFILE////////////////////
$route['ar/my-account']            = 'web/User/my_account';
$route['ar/checkout']              = 'web/User/checkout';
$route['ar/edit-profile']          = 'web/User/edit_profile';
$route['ar/change-password']       = 'web/User/change_password';
$route['ar/upload-image']          = 'web/User/upload_image';
$route['ar/user-transaction']      = 'web/User/user_transaction';
//////////////////////////COOKIE//////////////////////////////
$route['ar/my-cart']               = 'web/Web/my_cart';
$route['ar/address']               = 'web/Web/address';
//////////////////////////COOKIE//////////////////////////////

$route['ar/my-favourite-product']  = 'web/User/my_favourite_product';
$route['ar/booking-transaction-updated']      = 'web/Booking/booking_transaction_updated';
$route['ar/order-success']               = 'web/Web/order_success';
$route['ar/order-success/(:num)']               = 'web/Web/order_success';
$route['ar/success']               = 'web/User/success';
$route['ar/success/(:num)']               = 'web/User/success';
$route['ar/failure']               = 'web/User/failure';
$route['ar/booking-success']       = 'web/Web/booking_success';
$route['ar/booking-failure']       = 'web/User/booking_failure';
$route['ar/order-history']         = 'web/User/order_history';
$route['ar/order-detail/(:num)']   = 'web/User/order_detail';
$route['ar/my-request']            = 'web/User/my_request';
$route['ar/request-detail/(:num)'] = 'web/User/request_detail';
$route['ar/booking-history']       = 'web/User/booking_history';
$route['ar/booking-detail/(:num)'] = 'web/User/booking_detail';
$route['ar/user-bill/(:num)']             = 'web/User/user_bill';
$route['ar/my-notebook']             = 'web/User/my_notebook';
$route['ar/logout']                = 'web/User/logout';
//////////////////////////////USER PROFILE////////////////////

//////////////////////////////Service Module////////////////////

$route['ar/service-category']                          = 'web/web/service_category';
$route['ar/service-subcategory/(:num)']                = 'web/web/service_subcategory';
$route['ar/service-subcategory/(:num)/(:any)']         = 'web/web/service_subcategory';
$route['ar/service-provider/(:num)']                   = 'web/web/service_provider';
$route['ar/service-provider/(:num)/(:any)']            = 'web/web/service_provider';
$route['ar/service-provider/(:num)/(:any)/(:any)']     = 'web/web/service_provider';
$route['ar/service-list/(:num)/(:num)']                = 'web/web/service_list';
$route['ar/service-list/(:num)/(:num)/(:any)']         = 'web/web/service_list';
$route['ar/service-list/(:num)/(:num)/(:any)/(:any)']  = 'web/web/service_list';
$route['ar/service-list/(:num)/(:num)/(:any)/(:any)/(:any)']= 'web/web/service_list';
$route['ar/service-detail/(:num)']                     = 'web/web/service_detail';
$route['ar/service-detail/(:num)/(:any)']              = 'web/web/service_detail';
$route['ar/service-detail/(:num)/(:any)/(:any)']       = 'web/web/service_detail';
$route['ar/service-detail/(:num)/(:any)/(:any)/(:any)']= 'web/web/service_detail';
$route['ar/brand-list']                                = 'web/web/brand_list';
$route['ar/product-by-brand/(:num)']                   = 'web/web/product_by_brand';
$route['ar/product-by-brand/(:num)/(:any)']            = 'web/web/product_by_brand';
$route['ar/product-review/(:num)/(:num)/(:any)']      = 'web/web/product_review';
//////////////////////////////Service Module////////////////////

$route['ar/my-transaction']  = 'web/web/my_transaction';

$route['ar/about-us']  = 'web/web/about_us';
$route['ar/privacy-policy']  = 'web/web/privacy_policy';
$route['ar/terms-and-condition']  = 'web/web/terms_and_condition';
$route['ar/how-it-work']  = 'web/web/how_it_work';
$route['ar/contact-us']  = 'web/web/contact_us';
$route['ar/faq']  = 'web/web/faq';


$route['ar/mobile-about-us']  = 'web/web/mobile_about_us';
$route['ar/mobile-privacy-policy']  = 'web/web/mobile_privacy_policy';
$route['ar/mobile-terms-and-condition']  = 'web/web/mobile_terms_and_condition';
$route['ar/mobile-faq']  = 'web/web/mobile_faq';
//====================================Arabic Route//////////////////////////////

$route['product-detail/(:any)/(:num)']                          = 'web/webapp/product_detail';
$route['product-detail/(:any)/(:num)/(:num)']                   = 'web/webapp/product_detail';
$route['product-detail/(:any)/(:num)/(:num)/(:num)']            = 'web/webapp/product_detail';
$route['product-detail/(:any)/(:num)/(:num)/(:num)/(:num)']     = 'web/webapp/product_detail';
...
$route['admin/add-product-price']              			= 'admin/Home/add_product_price';
...
$route['admin/vendor-request-detail/(:any)']          			        = 'admin/Admin/request_detail';
 ...
 $route['admin/return-order-list']                                      = 'admin/Order/return_order_list';
 $route['admin/return-order-detail/(:any)']                             = 'admin/Order/return_order_detail';
...
$route['admin/user-note']                                               = 'admin/Settings/user_note';
$route['admin/user-note-list']                                          = 'admin/Settings/user_note_list';
$route['admin/vendor-note']                                             = 'admin/Settings/vendor_note';
$route['admin/vendor-note-list']                                        = 'admin/Settings/vendor_note_list';

$route['admin/send-user-notification']                                  = 'admin/Settings/send_user_notification';

$route['admin/send-notification']                                       = 'admin/Settings/send_notification';


$route['admin/create-layout']                                           = 'admin/Home/create_layout';
$route['admin/create-layout/(:num)']                                    = 'admin/Home/create_layout';
$route['admin/home-layout-product/(:num)']                              = 'admin/Home/home_layout_product';
